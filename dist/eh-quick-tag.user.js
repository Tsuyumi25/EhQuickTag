...
// @description:ja     E-Hentai / ExHentai 検索クイックタグバー、各種タグ機能の強化付き
// @description:ko     E-Hentai / ExHentai 검색용 퀵 태그 바, 다양한 태그 기능 개선 포함
// @license            MIT
...
(function() {
  'use strict';
	...
	var _hoisted_3$19 = [createBaseVNode("path", {
		fill: "currentColor",
		d: "M504 256c0 136.967-111.033 248-248 248S8 392.967 8 256 119.033 8 256 8s248 111.033 248 248zM227.314 387.314l184-184c6.248-6.248 6.248-16.379 0-22.627l-22.627-22.627c-6.248-6.249-16.379-6.249-22.628 0L216 308.118l-70.059-70.059c-6.248-6.248-16.379-6.248-22.628 0l-22.627 22.627c-6.248 6.248-6.248 16.379 0 22.627l104 104c6.249 6.249 16.379 6.249 22.628.001z"
	}, null, -1)];
	function render3(_ctx, _cache) {
		return openBlock(), createElementBlock("svg", _hoisted_12$10, _hoisted_3$19);
	}
	...
	var _hoisted_32$2 = [createBaseVNode("path", {
		fill: "currentColor",
		d: "M256 8C119.043 8 8 119.083 8 256c0 136.997 111.043 248 248 248s248-111.003 248-248C504 119.083 392.957 8 256 8zm0 110c23.196 0 42 18.804 42 42s-18.804 42-42 42-42-18.804-42-42 18.804-42 42-42zm56 254c0 6.627-5.373 12-12 12h-88c-6.627 0-12-5.373-12-12v-24c0-6.627 5.373-12 12-12h12v-64h-12c-6.627 0-12-5.373-12-12v-24c0-6.627 5.373-12 12-12h64c6.627 0 12 5.373 12 12v100h12c6.627 0 12 5.373 12 12v24z"
	}, null, -1)];
	function render4(_ctx, _cache) {
		return openBlock(), createElementBlock("svg", _hoisted_13$9, _hoisted_32$2);
	}
	...
	var _hoisted_33$2 = [createBaseVNode("path", {
		fill: "currentColor",
		d: "M504 256c0 136.997-111.043 248-248 248S8 392.997 8 256C8 119.083 119.043 8 256 8s248 111.083 248 248zm-248 50c-25.405 0-46 20.595-46 46s20.595 46 46 46 46-20.595 46-46-20.595-46-46-46zm-43.673-165.346l7.418 136c.347 6.364 5.609 11.346 11.982 11.346h48.546c6.373 0 11.635-4.982 11.982-11.346l7.418-136c.375-6.874-5.098-12.654-11.982-12.654h-63.383c-6.884 0-12.356 5.78-11.981 12.654z"
	}, null, -1)];
	function render5(_ctx, _cache) {
		return openBlock(), createElementBlock("svg", _hoisted_14$8, _hoisted_33$2);
	}
	...
	var _hoisted_34$2 = [createBaseVNode("path", {
		fill: "currentColor",
		d: "M569.517 440.013C587.975 472.007 564.806 512 527.94 512H48.054c-36.937 0-59.999-40.055-41.577-71.987L246.423 23.985c18.467-32.009 64.72-31.951 83.154 0l239.94 416.028zM288 354c-25.405 0-46 20.595-46 46s20.595 46 46 46 46-20.595 46-46-20.595-46-46-46zm-43.673-165.346l7.418 136c.347 6.364 5.609 11.346 11.982 11.346h48.546c6.373 0 11.635-4.982 11.982-11.346l7.418-136c.375-6.874-5.098-12.654-11.982-12.654h-63.383c-6.884 0-12.356 5.78-11.981 12.654z"
	}, null, -1)];
	function render6(_ctx, _cache) {
		return openBlock(), createElementBlock("svg", _hoisted_15$8, _hoisted_34$2);
	}
	...
	function render8(_ctx, _cache) {
		...
		return openBlock(), createElementBlock("div", {
			...
			createBaseVNode("div", {
				...
				key: 1,
				"toast-id": _ctx.id
			}, _ctx.hasProp(_ctx.content, "props") ? _ctx.content.props : {}, toHandlers(_ctx.hasProp(_ctx.content, "listeners") ? _ctx.content.listeners : {}), { onCloseToast: _ctx.closeToast }), null, 16, ["toast-id", "onCloseToast"]))], 10, _hoisted_16$8),
	...
	var MESSAGES = {
		"zh-TW": {
			...
			"tagbar.none": "無",
			"tagbar.infoPreviewSection": "預覽",
			"tagbar.infoPreviewLeft": "左鍵雙擊：{action}",
			"tagbar.infoPreviewRight": "右鍵雙擊：{action}",
			"tagbar.infoHint": "可在設定裡調整",
			"tagbar.infoEditSection": "編輯",
			"tagbar.infoEditLeft": "左鍵點按鈕：編輯內容",
			"tagbar.infoEditRight": "右鍵點按鈕：開啟選單",
			"tagbar.infoEditDrag": "從下方拖曳：{tools}",
			"tagbar.infoListSeparator": "、",
			"tagbar.newProfile": "點擊命名新標籤組",
			"tagbar.handleTitle": "拖曳排序行",
			"tagbar.lineActions": "行操作",
			"tagbar.tagActions": "按鈕操作",
			"tagbar.moveTag": "移動到 Profile",
			...
			"tagbar.addButtonLine": "空行",
			"tagbar.addSeparatorLine": "分隔線",
			"tagbar.spacerModeFixed": "間隔",
			"tagbar.spacerModeFlex": "彈簧",
			"tagbar.spacerFlexLabel": "彈簧",
			"tagbar.spacerResizeTitle": "拖曳調整寬度",
			"tagbar.addTag": "新增標籤",
			"tagbar.addUrl": "新增網址",
			...
			"settings.sectionUrlButton": "連結按鈕",
			"settings.followCurrentSite": "連結自動跟著目前所在的站 (e-hentai / exhentai)",
			"settings.tagStyle": "按鈕樣式",
			"settings.buttonLineTextAlign": "普通行",
			"settings.separatorLineTextAlign": "分隔線",
			"settings.sectionLineAlignment": "預設對齊",
			...
			"category.manga": "漫畫",
			"category.artistCg": "畫師CG",
			"category.gameCg": "遊戲CG",
			"category.western": "西方",
			"category.nonH": "無H",
			"category.imageSet": "圖集",
			"category.cosplay": "Cosplay",
			"category.asianPorn": "亞洲色情",
			"category.misc": "雜項",
			"urlBuilder.keywords": "搜尋關鍵字",
			"urlBuilder.useCurrentPage": "使用當前頁面",
			"urlBuilder.categories": "分類",
			"urlBuilder.showAdvanced": "顯示進階搜尋",
			"urlBuilder.browseExpunged": "只顯示已刪除的圖庫",
			"urlBuilder.requireTorrent": "只顯示有種子的圖庫",
			"urlBuilder.pagesBetween": "介於",
			"urlBuilder.pagesAnd": "和",
			"urlBuilder.pagesUnit": "頁",
			"urlBuilder.minRating": "最低評分：",
			"urlBuilder.anyRating": "無限制",
			"urlBuilder.stars": "{n} 星",
			"urlBuilder.disableFilters": "停用自訂過濾器：",
			"urlBuilder.filterLanguage": "語言",
			"urlBuilder.filterUploader": "上傳者",
			"urlBuilder.filterTags": "標籤",
			...
			"settings.galleryTaglistExpand": "自動展開",
			"settings.galleryTaglistHeightTipBefore": "可以到",
			"settings.galleryTaglistHeightTipLink": "這個 Tag 很多的圖庫",
			"settings.galleryTaglistHeightTipAfter": "查看效果",
			...
			"settings.sectionIntroPanel": "定義面板",
			"settings.introPanelPrimaryLang": "預設語言",
		...
		"zh-CN": {
			...
			"tagbar.none": "无",
			"tagbar.infoPreviewSection": "预览",
			"tagbar.infoPreviewLeft": "左键双击：{action}",
			"tagbar.infoPreviewRight": "右键双击：{action}",
			"tagbar.infoHint": "可在设置里调整",
			"tagbar.infoEditSection": "编辑",
			"tagbar.infoEditLeft": "左键点按钮：编辑内容",
			"tagbar.infoEditRight": "右键点按钮：打开菜单",
			"tagbar.infoEditDrag": "从下方拖曳：{tools}",
			"tagbar.infoListSeparator": "、",
			"tagbar.newProfile": "点击命名新标签组",
			"tagbar.handleTitle": "拖拽排序行",
			"tagbar.lineActions": "行操作",
			"tagbar.tagActions": "按钮操作",
			...
			"tagbar.lineAlignGlobal": "跟随全局（{align}）",
			"tagbar.lineAlignDefault": "默认",
			...
			"tagbar.separatorTextAlign_right": "靠右",
			"tagbar.addButtonLine": "空行",
			"tagbar.addSeparatorLine": "分隔线",
			"tagbar.spacerModeFixed": "间隔",
			"tagbar.spacerModeFlex": "弹簧",
			"tagbar.spacerFlexLabel": "弹簧",
			"tagbar.spacerResizeTitle": "拖拽调整宽度",
			"tagbar.addTag": "新增标签",
			"tagbar.addUrl": "新增网址",
			...
			"settings.sectionUrlButton": "链接按钮",
			"settings.followCurrentSite": "链接自动跟随当前所在的站 (e-hentai / exhentai)",
			"settings.tagStyle": "按钮样式",
			"settings.buttonLineTextAlign": "普通行",
			"settings.separatorLineTextAlign": "分隔线",
			"settings.sectionLineAlignment": "默认对齐",
			...
			"category.misc": "杂项",
			"urlBuilder.keywords": "搜索关键词",
			"urlBuilder.useCurrentPage": "使用当前页面",
			"urlBuilder.categories": "分类",
			"urlBuilder.showAdvanced": "显示高级搜索",
			"urlBuilder.browseExpunged": "只显示已删除的图库",
			"urlBuilder.requireTorrent": "只显示有种子的图库",
			"urlBuilder.pagesBetween": "介于",
			"urlBuilder.pagesAnd": "和",
			"urlBuilder.pagesUnit": "页",
			"urlBuilder.minRating": "最低评分：",
			"urlBuilder.anyRating": "无限制",
			"urlBuilder.stars": "{n} 星",
			"urlBuilder.disableFilters": "禁用自定义过滤器：",
			"urlBuilder.filterLanguage": "语言",
			"urlBuilder.filterUploader": "上传者",
			"urlBuilder.filterTags": "标签",
			...
			"settings.galleryTaglistExpand": "自动展开",
			"settings.galleryTaglistHeightTipBefore": "可以到",
			"settings.galleryTaglistHeightTipLink": "这个 Tag 很多的图库",
			"settings.galleryTaglistHeightTipAfter": "查看效果",
		...
		"en": {
			...
			"tagbar.none": "None",
			"tagbar.infoPreviewSection": "Preview",
			"tagbar.infoPreviewLeft": "Left double-click: {action}",
			"tagbar.infoPreviewRight": "Right double-click: {action}",
			"tagbar.infoHint": "Configurable in settings",
			"tagbar.infoEditSection": "Editing",
			"tagbar.infoEditLeft": "Left-click a button: edit it",
			"tagbar.infoEditRight": "Right-click a button: open its menu",
			"tagbar.infoEditDrag": "Drag in from below: {tools}",
			"tagbar.infoListSeparator": ", ",
			"tagbar.newProfile": "Click to name new profile",
			"tagbar.handleTitle": "Drag to reorder rows",
			"tagbar.lineActions": "Row actions",
			"tagbar.tagActions": "Button actions",
			...
			"tagbar.lineAlignGlobal": "Use global ({align})",
			"tagbar.lineAlignDefault": "Default",
			...
			"tagbar.addButtonLine": "Empty row",
			"tagbar.addSeparatorLine": "Separator",
			"tagbar.spacerModeFixed": "Gap",
			"tagbar.spacerModeFlex": "Spring",
			"tagbar.spacerFlexLabel": "spring",
			"tagbar.spacerResizeTitle": "Drag to resize",
			...
			"tagbar.toggleLang": "Toggle Chinese / English display",
			"tagbar.done": "Done",
			"tagbar.edit": "Edit",
			...
			"settings.searchPanelLang": "Button language",
			"settings.searchPanelLangAuto": "Auto",
			"settings.searchPanelLangToggle": "Chinese / English togglable",
			"settings.searchPanelLangEnglishOnly": "English only",
			"settings.convertToTraditional": "Convert Chinese tag names to Traditional (OpenCC)",
			...
			"settings.sectionUrlButton": "Link buttons",
			"settings.followCurrentSite": "Rewrite links to the site you are on (e-hentai / exhentai)",
			"settings.tagStyle": "Button style",
			"settings.buttonLineTextAlign": "Regular rows",
			"settings.separatorLineTextAlign": "Separators",
			"settings.sectionLineAlignment": "Default alignment",
			...
			"category.misc": "Misc",
			"urlBuilder.keywords": "Search keywords",
			"urlBuilder.useCurrentPage": "Use current page",
			"urlBuilder.categories": "Categories",
			"urlBuilder.showAdvanced": "Show advanced options",
			"urlBuilder.browseExpunged": "Browse expunged galleries only",
			"urlBuilder.requireTorrent": "Browse galleries with torrents only",
			"urlBuilder.pagesBetween": "Between",
			"urlBuilder.pagesAnd": "and",
			"urlBuilder.pagesUnit": "pages",
			"urlBuilder.minRating": "Minimum Rating:",
			"urlBuilder.anyRating": "Any Rating",
			"urlBuilder.stars": "{n} stars",
			"urlBuilder.disableFilters": "Disable custom filters for:",
			"urlBuilder.filterLanguage": "Language",
			"urlBuilder.filterUploader": "Uploader",
			"urlBuilder.filterTags": "Tags",
			...
			"about.openccDetail": "Simplified–Traditional Chinese conversion data (Apache-2.0)",
			...
			"settings.galleryTaglistExpand": "Auto-expand",
			"settings.galleryTaglistHeightTipBefore": "You can see the effect on ",
			"settings.galleryTaglistHeightTipLink": "this gallery with lots of tags",
			"settings.galleryTaglistHeightTipAfter": "",
		...
		"ja": {
			...
			"tagbar.none": "なし",
			"tagbar.infoPreviewSection": "プレビュー",
			"tagbar.infoPreviewLeft": "左ダブルクリック：{action}",
			"tagbar.infoPreviewRight": "右ダブルクリック：{action}",
			"tagbar.infoHint": "設定で変更できます",
			"tagbar.infoEditSection": "編集",
			"tagbar.infoEditLeft": "ボタンを左クリック：編集",
			"tagbar.infoEditRight": "ボタンを右クリック：メニューを開く",
			"tagbar.infoEditDrag": "下からドラッグ：{tools}",
			"tagbar.infoListSeparator": "、",
			"tagbar.newProfile": "クリックして新しいプロファイルに名前を付ける",
			"tagbar.handleTitle": "ドラッグして行を並べ替え",
			"tagbar.lineActions": "行の操作",
			"tagbar.tagActions": "ボタン操作",
			"tagbar.moveTag": "プロファイルに移動",
			...
			"tagbar.addButtonLine": "空行",
			"tagbar.addSeparatorLine": "区切り線",
			"tagbar.spacerModeFixed": "スペース",
			"tagbar.spacerModeFlex": "スプリング",
			"tagbar.spacerFlexLabel": "スプリング",
			"tagbar.spacerResizeTitle": "ドラッグで幅を調整",
			"tagbar.addTag": "タグを追加",
			...
			"settings.sectionUrlButton": "リンクボタン",
			"settings.followCurrentSite": "リンクを現在のサイトに合わせる (e-hentai / exhentai)",
			"settings.tagStyle": "ボタンスタイル",
			"settings.buttonLineTextAlign": "通常行",
			"settings.separatorLineTextAlign": "区切り線",
			"settings.sectionLineAlignment": "デフォルト配置",
			...
			"category.doujinshi": "同人誌",
			"category.manga": "漫画",
			"category.artistCg": "アーティストCG",
			"category.gameCg": "ゲームCG",
			"category.western": "西洋",
			"category.nonH": "Non-H",
			"category.imageSet": "画集",
			"category.cosplay": "コスプレ",
			"category.asianPorn": "アジアポルノ",
			"category.misc": "その他",
			"urlBuilder.keywords": "検索キーワード",
			"urlBuilder.useCurrentPage": "現在のページを使う",
			"urlBuilder.categories": "カテゴリ",
			"urlBuilder.showAdvanced": "詳細オプションを表示",
			"urlBuilder.browseExpunged": "削除済みギャラリーのみ表示",
			"urlBuilder.requireTorrent": "トレント有りのギャラリーのみ表示",
			"urlBuilder.pagesBetween": "ページ数",
			"urlBuilder.pagesAnd": "〜",
			"urlBuilder.pagesUnit": "",
			"urlBuilder.minRating": "最低評価：",
			"urlBuilder.anyRating": "指定なし",
			"urlBuilder.stars": "{n} つ星",
			"urlBuilder.disableFilters": "カスタムフィルタを無効化：",
			"urlBuilder.filterLanguage": "言語",
			"urlBuilder.filterUploader": "アップローダー",
			"urlBuilder.filterTags": "タグ",
			...
			"settings.galleryTaglistHeightTipLink": "この Tag が多い Gallery",
			"settings.galleryTaglistHeightTipAfter": " で効果を確認できる",
		...
		"ko": {
			...
			"tagbar.none": "없음",
			"tagbar.infoPreviewSection": "미리보기",
			"tagbar.infoPreviewLeft": "왼쪽 더블클릭: {action}",
			"tagbar.infoPreviewRight": "오른쪽 더블클릭: {action}",
			"tagbar.infoHint": "설정에서 변경할 수 있습니다",
			"tagbar.infoEditSection": "편집",
			"tagbar.infoEditLeft": "버튼 왼쪽 클릭: 편집",
			"tagbar.infoEditRight": "버튼 오른쪽 클릭: 메뉴 열기",
			"tagbar.infoEditDrag": "아래에서 드래그: {tools}",
			"tagbar.infoListSeparator": ", ",
			"tagbar.newProfile": "클릭하여 새 프로필 이름 지정",
			"tagbar.handleTitle": "드래그하여 행 순서 변경",
			"tagbar.lineActions": "행 작업",
			"tagbar.tagActions": "버튼 작업",
			"tagbar.moveTag": "프로필로 이동",
			...
			"tagbar.addButtonLine": "빈 행",
			"tagbar.addSeparatorLine": "구분선",
			"tagbar.spacerModeFixed": "간격",
			"tagbar.spacerModeFlex": "스프링",
			"tagbar.spacerFlexLabel": "스프링",
			"tagbar.spacerResizeTitle": "드래그로 너비 조절",
			"tagbar.addTag": "태그 추가",
			...
			"tagbar.toggleLang": "중국어 / 영어 표시 전환",
			"tagbar.done": "완료",
			"tagbar.edit": "편집",
			"tagbar.settings": "설정",
			"settings.title": "설정",
			...
			"settings.searchPanelLangToggle": "중국어 / 영어 전환 가능",
			"settings.searchPanelLangEnglishOnly": "영어만",
			"settings.convertToTraditional": "중국어 태그명을 번체자로 변환 (OpenCC)",
			...
			"settings.sectionUrlButton": "링크 버튼",
			"settings.followCurrentSite": "링크를 현재 접속 중인 사이트에 맞춤 (e-hentai / exhentai)",
			"settings.tagStyle": "버튼 스타일",
			"settings.buttonLineTextAlign": "일반 행",
			"settings.separatorLineTextAlign": "구분선",
			"settings.sectionLineAlignment": "기본 정렬",
			...
			"category.asianPorn": "아시안 포르노",
			"category.misc": "기타",
			"urlBuilder.keywords": "검색 키워드",
			"urlBuilder.useCurrentPage": "현재 페이지 사용",
			"urlBuilder.categories": "카테고리",
			"urlBuilder.showAdvanced": "고급 옵션 표시",
			"urlBuilder.browseExpunged": "삭제된 갤러리만 표시",
			"urlBuilder.requireTorrent": "토렌트 있는 갤러리만 표시",
			"urlBuilder.pagesBetween": "페이지 수",
			"urlBuilder.pagesAnd": "~",
			"urlBuilder.pagesUnit": "",
			"urlBuilder.minRating": "최소 평점:",
			"urlBuilder.anyRating": "제한 없음",
			"urlBuilder.stars": "{n}점",
			"urlBuilder.disableFilters": "사용자 필터 비활성화:",
			"urlBuilder.filterLanguage": "언어",
			"urlBuilder.filterUploader": "업로더",
			"urlBuilder.filterTags": "태그",
			...
			"about.openccDetail": "간체·번체 변환 데이터 (Apache-2.0)",
	...
	var _hoisted_1$21 = { class: "eqt-color-picker" };
	var _hoisted_2$18 = ["color"];
	var _hoisted_3$18 = { class: "eqt-color-picker__input-row" };
	var _hoisted_4$16 = ["onKeydown"];
	var _hoisted_5$15 = ["disabled", "title"];
	var _hoisted_6$14 = { class: "eqt-color-picker__input-row" };
	var _hoisted_7$13 = ["onKeydown"];
	var _hoisted_8$11 = ["disabled", "title"];
		...
		setup(__props, { emit: __emit }) {
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", _hoisted_1$21, [
					...
					createBaseVNode("div", _hoisted_3$18, [withDirectives(createBaseVNode("input", {
					...
					}, null, 40, _hoisted_4$16), [[vModelText, hexText.value]]), createBaseVNode("button", {
						type: "button",
					...
					createBaseVNode("div", _hoisted_6$14, [withDirectives(createBaseVNode("input", {
					...
					}, null, 40, _hoisted_7$13), [[vModelText, rgbText.value]]), createBaseVNode("button", {
						type: "button",
						class: "eqt-color-picker__copy",
	...
	var LineColorSwatch_default = defineComponent({
		...
		setup(__props, { emit: __emit }) {
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock(Fragment, null, [!__props.embedded ? (openBlock(), createElementBlock("button", mergeProps({
					key: 0,
					ref_key: "triggerEl",
					ref: triggerEl
				}, _ctx.$attrs, {
				...
				}), [createVNode(unref(Palette), { size: 12 })], 16, _hoisted_1$20)) : createCommentVNode("", true), (openBlock(), createBlock(resolveDynamicComponent(__props.embedded ? "div" : AnchoredPopover_default), {
					open: open.value,
					"onUpdate:open": _cache[2] || (_cache[2] = ($event) => open.value = $event),
					anchor: triggerEl.value
				}, {
					default: withCtx(() => [createBaseVNode("div", { class: normalizeClass(["eqt-line-color__popup", { "eqt-line-color__popup--embedded": __props.embedded }]) }, [createVNode(ColorPicker_default, {
						...
						onClick: clearColor
					}, [createVNode(unref(X), { size: 12 }), createTextVNode(" " + toDisplayString(unref(t)("tagbar.lineColorClear")), 1)])], 2)]),
					_: 1
				}, 40, ["open", "anchor"]))], 64);
			};
		}
	...
	var _hoisted_2$17 = { class: "eqt-line-sep__field" };
	var _hoisted_3$17 = { class: "eqt-line-sep__field-label" };
	var _hoisted_4$15 = { class: "eqt-line-sep__options eqt-line-sep__options--four" };
	var _hoisted_5$14 = ["title"];
	var _hoisted_6$13 = ["onClick"];
	var _hoisted_7$12 = { class: "eqt-line-sep__field" };
	var _hoisted_8$10 = { class: "eqt-line-sep__field-label" };
	var _hoisted_9$10 = { class: "eqt-line-sep__options" };
	var _hoisted_10$9 = ["onClick"];
	var _hoisted_11$9 = { class: "eqt-line-sep__field" };
	var _hoisted_12$9 = { class: "eqt-line-sep__field-label" };
	var _hoisted_13$8 = { class: "eqt-line-sep__options" };
	var _hoisted_14$7 = ["onClick"];
	var _hoisted_15$7 = { class: "eqt-line-sep__field" };
	var _hoisted_16$7 = { class: "eqt-line-sep__slider-head" };
	var _hoisted_17$6 = { class: "eqt-line-sep__field-label" };
	var _hoisted_18$6 = { class: "eqt-line-sep__slider-value" };
	var _hoisted_19$6 = ["value"];
	var _hoisted_20$6 = { class: "eqt-line-sep__field" };
	var _hoisted_21$6 = { class: "eqt-line-sep__slider-head" };
	var _hoisted_22$6 = { class: "eqt-line-sep__field-label" };
	var _hoisted_23$6 = { class: "eqt-line-sep__slider-value" };
	var _hoisted_24$5 = ["value", "disabled"];
	var _hoisted_25$3 = { class: "eqt-line-sep__field" };
	var _hoisted_26$3 = { class: "eqt-line-sep__slider-head" };
	var _hoisted_27$3 = { class: "eqt-line-sep__field-label" };
	var _hoisted_28$3 = { class: "eqt-line-sep__slider-value" };
	var _hoisted_29$3 = ["value", "disabled"];
	var _hoisted_30$2 = { class: "eqt-line-sep__footer" };
	var _hoisted_31$2 = ["disabled", "title"];
	var SeparatorSettingsPopup_default = defineComponent({
		...
		setup(__props, { emit: __emit }) {
			...
			const open = ref(false);
			const triggerEl = ref(null);
			const lineStyleValue = computed(() => props.line.kind === "separator" ? props.line.style?.line ?? "solid" : "solid");
			const linePositionValue = computed(() => props.line.kind === "separator" ? props.line.style?.linePosition ?? "middle" : "middle");
			const textAlignValue = computed(() => props.line.style?.textAlign ?? props.defaultTextAlign ?? "left");
			const usesDefaultTextAlign = computed(() => props.line.style?.textAlign === void 0);
			const textSizeValue = computed(() => props.line.kind === "separator" ? props.line.style?.textSize ?? 10 : 10);
			const lineThicknessValue = computed(() => props.line.kind === "separator" ? props.line.style?.lineThickness ?? 2 : 2);
			const lineLengthValue = computed(() => props.line.kind === "separator" ? props.line.style?.lineLength ?? 100 : 100);
			const canReset = computed(() => props.line.style !== void 0 && Object.keys(props.line.style).length > 0);
			function updateStyle(patch) {
				if (props.line.kind === "buttons") {
					const style = {
						...props.line.style,
						...patch.textAlign ? { textAlign: patch.textAlign } : {}
					};
					emit("update:line", {
						...props.line,
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock(Fragment, null, [!__props.embedded ? (openBlock(), createElementBlock("button", {
					key: 0,
					ref_key: "triggerEl",
					ref: triggerEl,
					type: "button",
					...
					onClick: _cache[0] || (_cache[0] = ($event) => open.value = !open.value)
				}, [createVNode(unref(Settings), { size: 12 })], 8, _hoisted_1$19)) : createCommentVNode("", true), (openBlock(), createBlock(resolveDynamicComponent(__props.embedded ? "div" : AnchoredPopover_default), {
					open: open.value,
					"onUpdate:open": _cache[4] || (_cache[4] = ($event) => open.value = $event),
					anchor: triggerEl.value
				}, {
					default: withCtx(() => [createBaseVNode("div", { class: normalizeClass(["eqt-line-sep__popup", { "eqt-line-sep__popup--embedded": __props.embedded }]) }, [
						createBaseVNode("div", _hoisted_2$17, [createBaseVNode("span", _hoisted_3$17, toDisplayString(__props.line.kind === "buttons" ? unref(t)("tagbar.lineAlign") : unref(t)("tagbar.separatorTextAlign")), 1), createBaseVNode("div", _hoisted_4$15, [createBaseVNode("button", {
							type: "button",
							class: normalizeClass(["eqt-line-sep__option", { "eqt-line-sep__option--active": usesDefaultTextAlign.value }]),
							title: unref(t)("tagbar.lineAlignGlobal", { align: unref(t)(`tagbar.separatorTextAlign_${__props.defaultTextAlign ?? "left"}`) }),
							onClick: clearTextAlign
						}, toDisplayString(unref(t)("tagbar.lineAlignDefault")), 11, _hoisted_5$14), (openBlock(), createElementBlock(Fragment, null, renderList([
							"left",
							"center",
							"right"
						], (opt) => {
							return createBaseVNode("button", {
								key: opt,
								type: "button",
								class: normalizeClass(["eqt-line-sep__option", { "eqt-line-sep__option--active": !usesDefaultTextAlign.value && textAlignValue.value === opt }]),
								onClick: ($event) => updateStyle({ textAlign: opt })
							}, toDisplayString(unref(t)(`tagbar.separatorTextAlign_${opt}`)), 11, _hoisted_6$13);
						}), 64))])]),
						__props.line.kind === "separator" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
							createBaseVNode("div", _hoisted_7$12, [createBaseVNode("span", _hoisted_8$10, toDisplayString(unref(t)("tagbar.separatorLinePosition")), 1), createBaseVNode("div", _hoisted_9$10, [(openBlock(), createElementBlock(Fragment, null, renderList([
								"top",
								"middle",
								"bottom"
							], (opt) => {
								return createBaseVNode("button", {
									key: opt,
									type: "button",
									class: normalizeClass(["eqt-line-sep__option", { "eqt-line-sep__option--active": linePositionValue.value === opt }]),
									onClick: ($event) => updateStyle({ linePosition: opt })
								}, toDisplayString(unref(t)(`tagbar.separatorLinePosition_${opt}`)), 11, _hoisted_10$9);
							}), 64))])]),
							createBaseVNode("div", _hoisted_11$9, [createBaseVNode("span", _hoisted_12$9, toDisplayString(unref(t)("tagbar.separatorStyle")), 1), createBaseVNode("div", _hoisted_13$8, [(openBlock(), createElementBlock(Fragment, null, renderList([
								"solid",
								"dashed",
								"none"
							], (opt) => {
								return createBaseVNode("button", {
									key: opt,
									type: "button",
									class: normalizeClass(["eqt-line-sep__option", { "eqt-line-sep__option--active": lineStyleValue.value === opt }]),
									onClick: ($event) => updateStyle({ line: opt })
								}, toDisplayString(unref(t)(`tagbar.separatorStyle_${opt}`)), 11, _hoisted_14$7);
							}), 64))])]),
							createBaseVNode("div", _hoisted_15$7, [createBaseVNode("div", _hoisted_16$7, [createBaseVNode("span", _hoisted_17$6, toDisplayString(unref(t)("tagbar.separatorTextSize")), 1), createBaseVNode("span", _hoisted_18$6, toDisplayString(textSizeValue.value) + "px", 1)]), createBaseVNode("input", {
							...
							createBaseVNode("div", _hoisted_20$6, [createBaseVNode("div", _hoisted_21$6, [createBaseVNode("span", _hoisted_22$6, toDisplayString(unref(t)("tagbar.separatorLineThickness")), 1), createBaseVNode("span", _hoisted_23$6, toDisplayString(lineThicknessValue.value) + "px", 1)]), createBaseVNode("input", {
								class: "eqt-line-sep__slider",
								type: "range",
								min: "1",
								max: "6",
							...
							createBaseVNode("div", _hoisted_25$3, [createBaseVNode("div", _hoisted_26$3, [createBaseVNode("span", _hoisted_27$3, toDisplayString(unref(t)("tagbar.separatorLineLength")), 1), createBaseVNode("span", _hoisted_28$3, toDisplayString(lineLengthValue.value) + "%", 1)]), createBaseVNode("input", {
								class: "eqt-line-sep__slider",
								type: "range",
								min: "1",
								max: "100",
						...
						createBaseVNode("div", _hoisted_30$2, [createBaseVNode("button", {
							...
							onClick: resetLayout
						}, toDisplayString(unref(t)("settings.reset")), 9, _hoisted_31$2)])
					], 2)]),
					_: 1
				}, 40, ["open", "anchor"]))], 64);
			};
	...
	var _hoisted_1$18 = ["role", "aria-label"];
	var ContextMenu_default = defineComponent({
		...
		setup(__props, { emit: __emit }) {
			...
			const { floatingStyles } = useFloating(computed(() => {
			...
			onClickOutside(menuEl, close, { ignore: computed(() => [...childIgnoreList.value, ...(props.ignore ?? []).filter((el) => el !== null)]) });
			watch(() => [props.open, props.anchorEl], async ([open]) => {
				if (!open || !props.autoFocus) return;
				await nextTick();
				menuEl.value?.querySelector("button:not(:disabled), input:not(:disabled), [tabindex]:not([tabindex=\"-1\"])")?.focus({ preventScroll: true });
			}, { immediate: true });
			useEventListener(document, "keydown", (e) => {
			...
			return (_ctx, _cache) => {
				return openBlock(), createBlock(Teleport, { to: "body" }, [__props.open ? (openBlock(), createElementBlock("div", {
					...
					translate: "no",
					role: __props.ariaRole ?? "menu",
					"aria-label": __props.ariaLabel,
					onContextmenu: _cache[0] || (_cache[0] = withModifiers(() => {}, ["prevent"]))
				}, [renderSlot(_ctx.$slots, "default")], 44, _hoisted_1$18)) : createCommentVNode("", true)]);
			};
		}
	});
	...
	var EH_DOMAINS = ["e-hentai.org", "exhentai.org"];
	var EH_ORIGIN = "https://e-hentai.org";
	function isEhUrl(u) {
	...
	function resolveButtonUrl(raw, follow, currentOrigin) {
	...
	var INITIAL_SETTINGS = {
		...
		tagWikiTtlDays: 7,
		tagStylePreset: "flat",
		buttonLineTextAlign: "left",
		separatorLineTextAlign: "left",
	...
	var dblClickLeftNewTabActive = refs.dblClickLeftNewTabActive;
	var dblClickRightNewTabActive = refs.dblClickRightNewTabActive;
	...
	var buttonLineTextAlign = refs.buttonLineTextAlign;
	var separatorLineTextAlign = refs.separatorLineTextAlign;
	var useAccentOnInclude = refs.useAccentOnInclude;
	var searchPanelShowZh = refs.searchPanelShowZh;
	...
	var galleryTaglistExpand = refs.galleryTaglistExpand;
	var galleryTaglistHeight = refs.galleryTaglistHeight;
	var galleryTaglistZoom = refs.galleryTaglistZoom;
	...
	var galleryDblClickLeftNewTabActive = refs.galleryDblClickLeftNewTabActive;
	var galleryDblClickRightNewTabActive = refs.galleryDblClickRightNewTabActive;
	var wikiPreludeExpanded = refs.wikiPreludeExpanded;
	var followCurrentSite = refs.followCurrentSite;
	...
	var DEFAULT_LINE_DEFS = [
		...
		},
		{
			...
			buttons: [
				{
					kind: "url",
					url: "https://e-hentai.org/?f_cats=0&f_search=o%3A%22how+to%24%22",
					labelKey: "default.howto"
				},
				{
					kind: "url",
					url: "https://e-hentai.org/?f_cats=0&f_search=o%3Aartbook%24",
					labelKey: "default.artbook"
				},
				{
					kind: "url",
					url: "https://e-hentai.org/?f_cats=991",
					labelKey: "default.imageset"
				},
				{
					kind: "url",
					url: "https://e-hentai.org/?f_cats=1019&f_search=o%3Atankoubon%24",
					labelKey: "default.tankoubon"
				},
				{
					kind: "url",
					url: "https://e-hentai.org/?f_cats=1019&f_search=o%3Aanthology%24",
	...
	function isValidButton(x) {
		...
		if (o.kind === "spacer") return (o.mode === "flex" || o.mode === "fixed") && (o.width === void 0 || typeof o.width === "number" && Number.isFinite(o.width) && o.width > 0);
		return false;
	}
	...
	var lines = reactive([]);
	function normalizeDefaultProfileLineAlignment() {
		for (const profile of [...profiles, ...deletedProfiles]) {
			if (!profile.isDefault) continue;
			for (const line of profile.lines) {
				if (line.kind !== "separator" || line.style?.textAlign === void 0) continue;
				const style = { ...line.style };
				delete style.textAlign;
				line.style = Object.keys(style).length ? style : void 0;
			}
		}
	}
	function normalizeButtonUrls() {
		for (const profile of [...profiles, ...deletedProfiles]) for (const line of profile.lines) {
	...
	async function loadStore() {
		...
		const legacy = parsed;
		if (typeof legacy.searchPanelShowCJK === "boolean" && !("searchPanelShowZh" in parsed)) refs.searchPanelShowZh.value = legacy.searchPanelShowCJK;
	...
	function moveLineToProfile(lineIdx, targetProfileIdx) {
	...
	function appendToLastButtonLine(lineList, button) {
	...
	function moveButtonToProfile(lineIdx, buttonIdx, targetProfileIdx) {
		...
		appendToLastButtonLine(targetProfile.lines, JSON.parse(JSON.stringify(moved)));
	...
	function contentWidth(el) {
		...
		return el.getBoundingClientRect().width - (parseFloat(cs.paddingLeft) || 0) - (parseFloat(cs.paddingRight) || 0) - (parseFloat(cs.borderLeftWidth) || 0) - (parseFloat(cs.borderRightWidth) || 0);
	}
	var FIT_EPSILON = .005;
	function useBilingualWrap(opts) {
		...
		function bilingualWidths(zh, en) {
			version.value;
			return [getWidth(zh), getWidth(en)];
		}
		function chunk(items, getWidths) {
		...
		function refreshMetrics() {
			...
			if (!root) return;
			const widthEl = root.querySelector(opts.rowSelector);
			if (widthEl) containerWidth.value = contentWidth(widthEl);
			const itemRow = root.querySelector(opts.itemRowSelector);
	...
	var _hoisted_1$17 = { class: "eqt-search-panel__label" };
	var _hoisted_2$16 = { class: "eqt-search-panel__cells" };
	var _hoisted_3$16 = ["onClick", "onContextmenu"];
		...
		setup(__props, { emit: __emit }) {
			...
			const groups = computed(() => {
				...
				function pushTerm(positive, state) {
					...
					const zhEntry = parsed.namespace ? findEntryByNsTag(parsed.namespace, parsed.tag) : void 0;
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", {
					...
					return openBlock(), createElementBlock("div", {
					...
					}, [createBaseVNode("div", _hoisted_1$17, toDisplayString(group.label) + ":", 1), createBaseVNode("div", _hoisted_2$16, [(openBlock(true), createElementBlock(Fragment, null, renderList(group.rows, (row, rowIdx) => {
						return openBlock(), createBlock(unref(draggableComponent), mergeProps({ key: rowIdx }, { ref_for: true }, cloneDragOptions, {
							...
							}, toDisplayString(group.key === MISC_KEY ? term.displayFull : term.displayShort), 43, _hoisted_3$16)]),
							_: 2
	...
	var _hoisted_1$16 = { class: "eqt-search-controls" };
	var _hoisted_2$15 = { class: "eqt-search-controls__group" };
	var _hoisted_3$15 = ["title"];
	var _hoisted_4$14 = ["title"];
	var _hoisted_5$13 = { class: "eqt-search-controls__add-label" };
	var _hoisted_6$12 = { class: "eqt-search-controls__group" };
	var SearchControls_default = defineComponent({
		...
		setup(__props, { emit: __emit }) {
			...
			function toggleLang() {
				searchPanelShowZh.value = !searchPanelShowZh.value;
			}
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", _hoisted_1$16, [
					createBaseVNode("div", _hoisted_2$15, [__props.showLangToggle && unref(resolvedMode) === "toggle" ? (openBlock(), createElementBlock("button", {
						key: 0,
						class: "eqt-search-controls__lang-toggle",
						type: "button",
						title: unref(t)("tagbar.toggleLang"),
						onClick: toggleLang
					}, [createBaseVNode("span", { class: normalizeClass({ "eqt-search-controls__lang-hidden": !unref(searchPanelShowZh) }) }, "中文", 2), createBaseVNode("span", { class: normalizeClass({ "eqt-search-controls__lang-hidden": unref(searchPanelShowZh) }) }, "EN", 2)], 8, _hoisted_3$15)) : createCommentVNode("", true), __props.showClearHistory && unref(enableHistory) ? (openBlock(), createElementBlock("button", {
						key: 1,
					...
					}, [_cache[3] || (_cache[3] = createBaseVNode("span", { class: "eqt-search-controls__add-icon" }, "+", -1)), createBaseVNode("span", _hoisted_5$13, toDisplayString(unref(t)("tagbar.browseTag")), 1)], 8, _hoisted_4$14)) : createCommentVNode("", true),
					createBaseVNode("div", _hoisted_6$12, [__props.showClearSearch ? (openBlock(), createElementBlock("button", {
						key: 0,
						class: "eqt-search-controls__text-btn",
						type: "button",
	...
	var _hoisted_1$15 = { class: "eqt-search-panel__label" };
	var _hoisted_2$14 = { class: "eqt-search-panel__cells" };
	var _hoisted_3$14 = ["onClick"];
	var SearchPanel_default = defineComponent({
		...
		setup(__props, { emit: __emit }) {
			...
			function historyEntryTexts(positive) {
				...
				const enText = literal;
				const zhText = zhEntry ? `${t(`ns.${parsed.namespace}`)}:${zhDisplay(zhEntry.name)}` : enText;
				return {
					display: effectiveShowZh.value ? zhText : enText,
					zh: zhText,
					en: enText,
					literal
				};
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", { class: normalizeClass(["eqt-search-panel", { "eqt-search-panel--editing": __props.editing }]) }, [
					...
					unref(enableHistory) && historyDisplays.value.length ? (openBlock(), createElementBlock("div", {
						...
						class: "eqt-search-panel__row"
					}, [createBaseVNode("div", _hoisted_1$15, toDisplayString(unref(t)("tagbar.history")) + ":", 1), createBaseVNode("div", _hoisted_2$14, [(openBlock(true), createElementBlock(Fragment, null, renderList(historyRows.value, (row, rowIdx) => {
						return openBlock(), createBlock(unref(draggableComponent), mergeProps({ key: rowIdx }, { ref_for: true }, moveDragOptions, {
							...
							}, toDisplayString(item.display), 9, _hoisted_3$14)]),
							_: 1
						}, 16, [
							"model-value",
							"disabled",
	...
	var SNAP_LANDING_TOLERANCE = .51;
	function edgeSensitivity(align, edge) {
		if (align === "center") return edge === "right" ? .5 : -.5;
		if (align === "left") return edge === "right" ? 1 : 0;
		return edge === "left" ? -1 : 0;
	}
	function edgePosition(align, edge, width, rectLeft, rectRight) {
	...
	function findSnapNudge(input, widthF, scale) {
		let best = null;
		const collect = (edge, targets) => {
			...
			for (let i = 0; i < targets.length; i++) {
				...
				best = {
					distance,
					deltaX: (target - predicted) / motion,
					edge,
					target,
					index: i
				};
	...
	function computeSpacerResize(input) {
		const dir = input.side === "left" ? -1 : 1;
		const scale = (input.align === "center" ? 2 : 1) * dir;
		const clampWidth = (w) => Math.min(input.maxWidth, Math.max(8, w));
		...
		return {
			...
			width,
			guideX: nudge.target,
			guideIndex: nudge.index
		};
	}
	var _hoisted_1$14 = { class: "eqt-tag-bar__lines" };
	var _hoisted_2$13 = { class: "eqt-tag-bar__profile-row" };
	var _hoisted_3$13 = { class: "eqt-tag-bar__info" };
	var _hoisted_4$13 = { class: "eqt-tag-bar__info-text" };
	var _hoisted_5$12 = { class: "eqt-tag-bar__info-section" };
	var _hoisted_6$11 = { class: "eqt-tag-bar__info-row" };
	var _hoisted_7$11 = { class: "eqt-tag-bar__info-row" };
	var _hoisted_8$9 = { class: "eqt-tag-bar__info-hint" };
	var _hoisted_9$9 = { class: "eqt-tag-bar__info-section" };
	var _hoisted_10$8 = { class: "eqt-tag-bar__info-row" };
	var _hoisted_11$8 = { class: "eqt-tag-bar__info-row" };
	var _hoisted_12$8 = { class: "eqt-tag-bar__info-row" };
	var _hoisted_13$7 = ["disabled"];
	var _hoisted_14$6 = {
		key: 1,
		class: "eqt-tag-bar__profile-split"
	};
	var _hoisted_15$6 = ["tabindex", "disabled"];
	var _hoisted_16$6 = ["disabled"];
	var _hoisted_17$5 = ["title"];
	var _hoisted_18$5 = {
		key: 1,
	...
	var _hoisted_20$5 = {
		key: 0,
		class: "eqt-tag-bar__spacer-body"
	};
	var _hoisted_21$5 = ["title", "onPointerdown"];
	var _hoisted_22$5 = ["title", "onPointerdown"];
	var _hoisted_23$5 = ["href"];
	var _hoisted_24$4 = ["onClick", "onContextmenu"];
	var _hoisted_25$2 = ["onClick", "onContextmenu"];
	var _hoisted_26$2 = [
		"title",
		"aria-expanded",
		"onClick"
	];
	var _hoisted_27$2 = { class: "eqt-context-menu__label" };
	var _hoisted_28$2 = ["onClick"];
	var _hoisted_29$2 = { class: "eqt-context-menu__label" };
	var _hoisted_30$1 = { class: "eqt-context-menu__label" };
	var _hoisted_31$1 = { class: "eqt-context-menu__label" };
	var _hoisted_32$1 = ["onClick"];
	var _hoisted_33$1 = { class: "eqt-context-menu__label" };
	var _hoisted_34$1 = ["onClick"];
	var _hoisted_35$1 = { class: "eqt-context-menu__label" };
	var _hoisted_36$1 = { class: "eqt-context-menu__label" };
	var _hoisted_37$1 = { class: "eqt-context-menu__label" };
	var _hoisted_38$1 = { class: "eqt-context-menu__label" };
	var _hoisted_39$1 = { class: "eqt-context-menu__label" };
	var _hoisted_40$1 = ["onClick"];
	var _hoisted_41$1 = { class: "eqt-context-menu__label" };
	var _hoisted_42$1 = {
		key: 2,
		class: "eqt-tag-bar__search-area"
	};
	var _hoisted_43$1 = { class: "eqt-tag-bar__search-area-label" };
	var _hoisted_44$1 = { class: "eqt-tag-bar__bottom-row" };
	var _hoisted_45$1 = { class: "eqt-tag-bar__tool" };
	var _hoisted_46$1 = { class: "eqt-tag-bar__tool" };
	var _hoisted_47$1 = { class: "eqt-tag-bar__controls" };
	var _hoisted_48$1 = { class: "eqt-tag-bar__ctrl-split" };
	var TagBar_default = defineComponent({
		...
		setup(__props, { emit: __emit }) {
			...
			function preventNativeContextMenuWhileEditing(e) {
				if (!editing.value) return;
				if (e.target.closest("input, textarea, [contenteditable]")) return;
				e.preventDefault();
			}
			async function execDblClickAction(action, newTabActive) {
				...
				if (action === "clearSearch") emit("update:searchText", "");
					...
					await recordSubmitAndFlush();
					emit("search", action, action === "searchNewTab" ? newTabActive : void 0);
				}
			}
			...
			function onLineChange(evt) {
				if (evt.added) lines.splice(evt.added.newIndex, 0, evt.added.element);
				if (evt.moved) {
			...
			const dragToolNames = computed(() => [...lineTools.map((tool) => t(tool.kind === "separator" ? "tagbar.addSeparatorLine" : "tagbar.addButtonLine")), ...spacerTools.map((tool) => t(tool.mode === "flex" ? "tagbar.spacerModeFlex" : "tagbar.spacerModeFixed"))].join(t("tagbar.infoListSeparator")));
			const spacerGuide = ref(null);
			const resizingSpacer = ref(null);
			const resizingWidth = ref(null);
			function spacerRenderWidth(b) {
				if (resizingSpacer.value === b && resizingWidth.value !== null) return resizingWidth.value;
				return b.width ?? 40;
			}
			function lineAlignOf(line) {
			...
			function spacerHasGrip(b, align, side) {
				return b.mode === "fixed" && edgeSensitivity(align, side) !== 0;
			}
			let spacerResizeCtx = null;
			function onSpacerGripDown(e, li, b, align, side) {
				e.preventDefault();
				e.stopPropagation();
				if (spacerResizeCtx) {
			...
			function buildSpacerGuide(ctx, guideX, guideIndex, spacerRect) {
			...
			function onSpacerGripMove(e) {
				...
				spacerGuide.value = result.guideX !== null && result.guideIndex !== null ? buildSpacerGuide(ctx, result.guideX, result.guideIndex, rect) : null;
			}
			function finishSpacerResize() {
				const ctx = spacerResizeCtx;
				if (!ctx) return;
			...
			const lineMenuView = ref("menu");
			const lineMenuTrigger = ref(null);
			const lineMenuBack = ref(null);
			const lineMenuDrillTrigger = ref(null);
			function toggleLineMenu(e, li) {
			...
			function openLineMenuView(view, e) {
				lineMenuDrillTrigger.value = e.currentTarget;
				lineMenuView.value = view;
				nextTick(() => lineMenuBack.value?.focus({ preventScroll: true }));
			}
			function returnToLineMenu() {
				lineMenuView.value = "menu";
				nextTick(() => lineMenuDrillTrigger.value?.focus({ preventScroll: true }));
			}
			function focusLineMenuTriggerOrFallback(trigger) {
				if (!trigger) return;
				if (trigger.isConnected) {
					trigger.focus();
					return;
				}
				const actions = barEl.value?.querySelectorAll(".eqt-tag-bar__line-actions") ?? [];
			...
			function moveLine(li, profileIdx) {
				moveLineToProfile(li, profileIdx);
				lineMenuOpen.value = false;
			}
			function duplicateLine(li) {
				const line = lines[li];
				if (!line) return;
				lines.splice(li + 1, 0, JSON.parse(JSON.stringify(line)));
				lineMenuOpen.value = false;
			}
			function deleteLineFromMenu(li) {
				onDeleteLine(li);
				lineMenuOpen.value = false;
			}
			...
			const tagMenuPointerOffset = ref(null);
			const tagMenuView = ref("menu");
			const tagMenuTrigger = ref(null);
			const tagMenuRestoreFocus = ref(false);
			const tagMenuBack = ref(null);
			const tagMenuDrillTrigger = ref(null);
			const tagMenuButton = computed(() => {
			...
			async function openTagMenu(e, li, ti) {
				const line = lines[li];
				...
				tagMenuPointerOffset.value = openedFromKeyboard ? null : {
			...
			function focusTagMenuTriggerOrFallback(trigger) {
				if (!trigger) return;
				if (trigger.isConnected) {
					trigger.focus();
					return;
				...
				const buttons = wrap?.querySelectorAll(".eqt-tag-bar__btn, .eqt-tag-bar__spacer") ?? [];
				(buttons[Math.min(tagMenuButtonIdx.value, buttons.length - 1)] ?? wrap?.querySelector(".eqt-tag-bar__line-actions") ?? editToggleEl.value)?.focus();
			}
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", {
					...
					onContextmenuCapture: preventNativeContextMenuWhileEditing,
					onContextmenu: onBarContextMenu
				}, [_cache[24] || (_cache[24] = createBaseVNode("div", { class: "eqt-tag-bar__overlay" }, null, -1)), createBaseVNode("div", _hoisted_1$14, [
					createBaseVNode("div", _hoisted_2$13, [
						createBaseVNode("span", _hoisted_3$13, [createVNode(unref(Info), { size: 16 }), createBaseVNode("span", _hoisted_4$13, [
							createBaseVNode("span", _hoisted_5$12, toDisplayString(unref(t)("tagbar.infoPreviewSection")), 1),
							createBaseVNode("span", _hoisted_6$11, toDisplayString(unref(t)("tagbar.infoPreviewLeft", { action: unref(t)(ACTION_KEYS[unref(dblClickLeft)]) })), 1),
							createBaseVNode("span", _hoisted_7$11, toDisplayString(unref(t)("tagbar.infoPreviewRight", { action: unref(t)(ACTION_KEYS[unref(dblClickRight)]) })), 1),
							createBaseVNode("span", _hoisted_8$9, toDisplayString(unref(t)("tagbar.infoHint")), 1),
							createBaseVNode("span", _hoisted_9$9, toDisplayString(unref(t)("tagbar.infoEditSection")), 1),
							createBaseVNode("span", _hoisted_10$8, toDisplayString(unref(t)("tagbar.infoEditLeft")), 1),
							createBaseVNode("span", _hoisted_11$8, toDisplayString(unref(t)("tagbar.infoEditRight")), 1),
							createBaseVNode("span", _hoisted_12$8, toDisplayString(unref(t)("tagbar.infoEditDrag", { tools: dragToolNames.value })), 1)
						])]),
						createBaseVNode("button", {
							...
							onClick: onPrev
						}, [createTextVNode(toDisplayString(onCreationPage.value ? __props.profileName : __props.prevProfileName) + " ", 1), createVNode(unref(ChevronLeft), { size: 12 })], 8, _hoisted_13$7),
						...
						}, null, 544)), [[vModelText, renameValue.value]]) : (openBlock(), createElementBlock("div", _hoisted_14$6, [createBaseVNode("button", {
						...
						}, [createVNode(unref(Trash2), { size: 12 })], 10, _hoisted_15$6)])),
						createBaseVNode("button", {
							class: "eqt-tag-bar__profile-nav eqt-tag-bar__profile-nav--next",
							type: "button",
							disabled: onCreationPage.value,
							onClick: onNext
						}, [createVNode(unref(ChevronRight), { size: 12 }), createTextVNode(" " + toDisplayString(onCreationPage.value ? "" : __props.nextProfileName), 1)], 8, _hoisted_16$6)
					]),
					onCreationPage.value ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(unref(lines).length, (n) => {
						return openBlock(), createElementBlock("div", {
							key: n,
							class: "eqt-tag-bar__line-wrap eqt-tag-bar__line-wrap--placeholder"
						}, [..._cache[19] || (_cache[19] = [createBaseVNode("div", { class: "eqt-tag-bar__line" }, null, -1)])]);
						...
						onStart: closeActionMenus
					}), {
						item: withCtx(({ element: line, index: li }) => [createBaseVNode("div", { class: normalizeClass(["eqt-tag-bar__line-wrap", { "eqt-tag-bar__line-wrap--actions-active": lineMenuOpen.value && lineMenuIdx.value === li }]) }, [
							createBaseVNode("div", {
							...
							}, [createVNode(unref(GripVertical), { size: 14 })], 10, _hoisted_17$5)], 512),
							line.kind === "separator" ? (openBlock(), createElementBlock("div", {
								...
								class: normalizeClass(["eqt-tag-bar__line eqt-tag-bar__line--separator", [
									...
									`eqt-tag-bar__line--separator-align-${line.style?.textAlign ?? unref(separatorLineTextAlign)}`
								]]),
								...
								"onUpdate:modelValue",
								"data-placeholder"
							])) : line.label ? (openBlock(), createElementBlock("span", _hoisted_18$5, toDisplayString(line.label), 1)) : createCommentVNode("", true)], 6)) : (openBlock(), createBlock(unref(draggableComponent), mergeProps({ key: 1 }, tagDragOptions, {
								"model-value": line.buttons,
								"item-key": buttonKey,
								disabled: !editing.value,
								tag: "div",
								class: ["eqt-tag-bar__line", `eqt-tag-bar__line--buttons-align-${line.style?.textAlign ?? unref(buttonLineTextAlign)}`],
								style: line.color ? { "--line-color": line.color } : void 0,
								onChange: ($event) => onTagChange(li, $event),
								onStart: onTagStart,
								onEnd: onTagEnd
							}), {
								item: withCtx(({ element: b, index: ti }) => [b.kind === "spacer" ? (openBlock(), createElementBlock("div", {
									key: 0,
									class: normalizeClass(["eqt-tag-bar__spacer", [`eqt-tag-bar__spacer--${b.mode}`, {
										"eqt-tag-bar__spacer--editing": editing.value,
										"eqt-tag-bar__spacer--grip-left": editing.value && spacerHasGrip(b, lineAlignOf(line), "left"),
										"eqt-tag-bar__spacer--grip-right": editing.value && spacerHasGrip(b, lineAlignOf(line), "right")
									}]]),
									style: normalizeStyle(b.mode === "fixed" ? { width: `${spacerRenderWidth(b)}px` } : void 0),
									tabindex: editing.value ? 0 : void 0,
									role: editing.value ? "button" : void 0,
									"aria-label": editing.value ? unref(t)(b.mode === "flex" ? "tagbar.spacerModeFlex" : "tagbar.spacerModeFixed") : void 0,
									onContextmenu: ($event) => onSpacerContextMenu($event, li, ti)
								}, [
									editing.value ? (openBlock(), createElementBlock("span", _hoisted_20$5, toDisplayString(b.mode === "flex" ? `⇤ ${unref(t)("tagbar.spacerFlexLabel")} ⇥` : resizingSpacer.value === b ? `${spacerRenderWidth(b)}px` : "↔"), 1)) : createCommentVNode("", true),
									editing.value && spacerHasGrip(b, lineAlignOf(line), "left") ? (openBlock(), createElementBlock("span", {
										key: 1,
										class: "eqt-tag-bar__spacer-grip eqt-tag-bar__spacer-grip--left",
										title: unref(t)("tagbar.spacerResizeTitle"),
										onPointerdown: ($event) => onSpacerGripDown($event, li, b, lineAlignOf(line), "left"),
										onPointermove: onSpacerGripMove,
										onPointerup: onSpacerGripUp,
										onPointercancel: onSpacerGripUp,
										onLostpointercapture: onSpacerGripUp
									}, null, 40, _hoisted_21$5)) : createCommentVNode("", true),
									editing.value && spacerHasGrip(b, lineAlignOf(line), "right") ? (openBlock(), createElementBlock("span", {
										key: 2,
										class: "eqt-tag-bar__spacer-grip",
										title: unref(t)("tagbar.spacerResizeTitle"),
										onPointerdown: ($event) => onSpacerGripDown($event, li, b, lineAlignOf(line), "right"),
										onPointermove: onSpacerGripMove,
										onPointerup: onSpacerGripUp,
										onPointercancel: onSpacerGripUp,
										onLostpointercapture: onSpacerGripUp
									}, null, 40, _hoisted_22$5)) : createCommentVNode("", true)
								], 46, _hoisted_19$5)) : b.kind === "url" && !editing.value ? (openBlock(), createElementBlock("a", {
									key: 1,
									href: resolveUrl(b.url),
									class: "eqt-tag-bar__btn eqt-tag-bar__btn--url",
									style: normalizeStyle(b.color ? { "--line-color": b.color } : void 0)
								}, [createVNode(unref(ExternalLink), { size: 12 }), createTextVNode(" " + toDisplayString(b.label || b.url), 1)], 12, _hoisted_23$5)) : b.kind === "url" ? (openBlock(), createElementBlock("button", {
									key: 2,
									class: "eqt-tag-bar__btn eqt-tag-bar__btn--editing",
									type: "button",
									style: normalizeStyle(b.color ? { "--line-color": b.color } : void 0),
									onClick: ($event) => onConfigure(li, ti),
									onContextmenu: withModifiers(($event) => openTagMenu($event, li, ti), ["prevent", "stop"])
								}, [createVNode(unref(ExternalLink), { size: 12 }), createTextVNode(" " + toDisplayString(b.label || b.url), 1)], 44, _hoisted_24$4)) : (openBlock(), createElementBlock("button", {
									key: 3,
									...
									onContextmenu: withModifiers(($event) => editing.value ? openTagMenu($event, li, ti) : onRightClick($event, b), ["prevent", "stop"])
								}, toDisplayString(b.label || b.tags.join(", ")), 47, _hoisted_25$2))]),
								_: 2
							}, 1040, [
								"model-value",
								"disabled",
							...
							editing.value ? (openBlock(), createElementBlock("button", {
								...
								type: "button",
								title: unref(t)("tagbar.lineActions"),
								"aria-haspopup": "dialog",
								"aria-expanded": lineMenuOpen.value && lineMenuIdx.value === li,
								onClick: ($event) => toggleLineMenu($event, li)
							}, [createVNode(unref(Ellipsis), { size: 14 })], 8, _hoisted_26$2)) : createCommentVNode("", true),
							lineMenuIdx.value === li ? (openBlock(), createBlock(ContextMenu_default, {
								key: 3,
								open: lineMenuOpen.value,
								"onUpdate:open": _cache[6] || (_cache[6] = ($event) => lineMenuOpen.value = $event),
								"anchor-el": lineMenuTrigger.value,
								ignore: [lineMenuTrigger.value],
								"auto-focus": "",
								"aria-role": "dialog",
								"aria-label": unref(t)("tagbar.lineActions"),
								placement: "right-start"
							}, {
								default: withCtx(() => [lineMenuView.value === "menu" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
									unref(profiles).length > 1 ? (openBlock(), createElementBlock("button", {
										key: 0,
										type: "button",
										class: "eqt-context-menu__item",
										onClick: _cache[3] || (_cache[3] = ($event) => openLineMenuView("move", $event))
									}, [createVNode(unref(SquareDashedMousePointer), {
										size: 14,
										class: "eqt-context-menu__icon"
									}), createBaseVNode("span", _hoisted_27$2, toDisplayString(unref(t)("tagbar.moveLine")), 1)])) : createCommentVNode("", true),
									createBaseVNode("button", {
										type: "button",
										class: "eqt-context-menu__item",
										onClick: ($event) => duplicateLine(li)
									}, [createVNode(unref(CopyPlus), {
										size: 14,
										class: "eqt-context-menu__icon"
									}), createBaseVNode("span", _hoisted_29$2, toDisplayString(unref(t)("tagbar.duplicateLine")), 1)], 8, _hoisted_28$2),
									createBaseVNode("button", {
										type: "button",
										class: "eqt-context-menu__item",
										onClick: _cache[4] || (_cache[4] = ($event) => openLineMenuView("layout", $event))
									}, [createVNode(unref(Settings), {
										size: 14,
										class: "eqt-context-menu__icon"
									}), createBaseVNode("span", _hoisted_30$1, toDisplayString(unref(t)("tagbar.layout")), 1)]),
									createBaseVNode("button", {
										type: "button",
										class: "eqt-context-menu__item",
										onClick: _cache[5] || (_cache[5] = ($event) => openLineMenuView("color", $event))
									}, [createVNode(unref(Palette), {
										size: 14,
										class: "eqt-context-menu__icon"
									}), createBaseVNode("span", _hoisted_31$1, toDisplayString(unref(t)("tagbar.lineColor")), 1)]),
									_cache[20] || (_cache[20] = createBaseVNode("div", { class: "eqt-context-menu__separator" }, null, -1)),
									createBaseVNode("button", {
										type: "button",
										class: "eqt-context-menu__item eqt-context-menu__item--danger",
										onClick: ($event) => deleteLineFromMenu(li)
									}, [createVNode(unref(Trash2), {
										size: 14,
										class: "eqt-context-menu__icon"
									}), createBaseVNode("span", _hoisted_33$1, toDisplayString(unref(t)("tagbar.deleteLine")), 1)], 8, _hoisted_32$1)
								], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
									createBaseVNode("button", {
										ref_key: "lineMenuBack",
										ref: lineMenuBack,
										type: "button",
										class: "eqt-tag-bar__line-menu-back",
										onClick: returnToLineMenu
									}, [createVNode(unref(ArrowLeft), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("common.back")), 1)], 512),
									_cache[21] || (_cache[21] = createBaseVNode("div", { class: "eqt-context-menu__separator" }, null, -1)),
									lineMenuView.value === "move" ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(unref(profiles), (profile, pi) => {
										return withDirectives((openBlock(), createElementBlock("button", {
											key: pi,
											type: "button",
											class: "eqt-context-menu__item",
											onClick: ($event) => moveLine(li, pi)
										}, [createBaseVNode("span", _hoisted_35$1, toDisplayString(profile.name), 1)], 8, _hoisted_34$1)), [[vShow, pi !== unref(activeProfileIdx)]]);
									}), 128)) : lineMenuView.value === "layout" ? (openBlock(), createBlock(SeparatorSettingsPopup_default, {
										key: 1,
										embedded: "",
										line,
										"default-text-align": line.kind === "buttons" ? unref(buttonLineTextAlign) : unref(separatorLineTextAlign),
										"onUpdate:line": ($event) => onUpdateLine(li, $event)
									}, null, 8, [
										"line",
										"default-text-align",
										"onUpdate:line"
									])) : lineMenuView.value === "color" ? (openBlock(), createBlock(LineColorSwatch_default, {
										key: 2,
										embedded: "",
						...
						footer: withCtx(() => [spacerGuide.value ? (openBlock(), createElementBlock("div", {
							key: 0,
							class: "eqt-tag-bar__spacer-guide",
							style: normalizeStyle({
								left: `${spacerGuide.value.x}px`,
								top: `${spacerGuide.value.top}px`,
								height: `${spacerGuide.value.height}px`
							})
					...
					createVNode(ContextMenu_default, {
						open: tagMenuOpen.value,
						"onUpdate:open": _cache[11] || (_cache[11] = ($event) => tagMenuOpen.value = $event),
						"anchor-el": tagMenuTrigger.value,
						"pointer-offset": tagMenuPointerOffset.value,
						"auto-focus": "",
						"aria-role": "dialog",
						"aria-label": unref(t)("tagbar.tagActions"),
						placement: "bottom-start"
					}, {
						default: withCtx(() => [tagMenuView.value === "menu" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
							unref(profiles).length > 1 ? (openBlock(), createElementBlock("button", {
								key: 0,
								type: "button",
								class: "eqt-context-menu__item",
								onClick: _cache[7] || (_cache[7] = ($event) => openTagMenuView("move", $event))
							}, [createVNode(unref(SquareDashedMousePointer), {
								size: 14,
								class: "eqt-context-menu__icon"
							}), createBaseVNode("span", _hoisted_36$1, toDisplayString(unref(t)("tagbar.moveTag")), 1)])) : createCommentVNode("", true),
							createBaseVNode("button", {
								type: "button",
								class: "eqt-context-menu__item",
								onClick: _cache[8] || (_cache[8] = ($event) => duplicateTag(tagMenuLineIdx.value, tagMenuButtonIdx.value))
							}, [createVNode(unref(CopyPlus), {
								size: 14,
								class: "eqt-context-menu__icon"
							}), createBaseVNode("span", _hoisted_37$1, toDisplayString(unref(t)("tagbar.duplicateTag")), 1)]),
							tagMenuButton.value?.kind !== "spacer" ? (openBlock(), createElementBlock("button", {
								key: 1,
								type: "button",
								class: "eqt-context-menu__item",
								onClick: _cache[9] || (_cache[9] = ($event) => openTagMenuView("color", $event))
							}, [createVNode(unref(Palette), {
								size: 14,
								class: "eqt-context-menu__icon"
							}), createBaseVNode("span", _hoisted_38$1, toDisplayString(unref(t)("common.itemColor")), 1)])) : createCommentVNode("", true),
							_cache[22] || (_cache[22] = createBaseVNode("div", { class: "eqt-context-menu__separator" }, null, -1)),
							createBaseVNode("button", {
								type: "button",
								class: "eqt-context-menu__item eqt-context-menu__item--danger",
								onClick: _cache[10] || (_cache[10] = ($event) => deleteTag(tagMenuLineIdx.value, tagMenuButtonIdx.value))
							}, [createVNode(unref(Trash2), {
								size: 14,
								class: "eqt-context-menu__icon"
							}), createBaseVNode("span", _hoisted_39$1, toDisplayString(unref(t)("tagConfig.delete")), 1)])
						], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
							createBaseVNode("button", {
								ref_key: "tagMenuBack",
								ref: tagMenuBack,
								type: "button",
								class: "eqt-tag-bar__line-menu-back",
								onClick: returnToTagMenu
							}, [createVNode(unref(ArrowLeft), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("common.back")), 1)], 512),
							_cache[23] || (_cache[23] = createBaseVNode("div", { class: "eqt-context-menu__separator" }, null, -1)),
							tagMenuView.value === "move" ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(unref(profiles), (profile, pi) => {
								return withDirectives((openBlock(), createElementBlock("button", {
									key: pi,
									type: "button",
									class: "eqt-context-menu__item",
									onClick: ($event) => moveTag(tagMenuLineIdx.value, tagMenuButtonIdx.value, pi)
								}, [createBaseVNode("span", _hoisted_41$1, toDisplayString(profile.name), 1)], 8, _hoisted_40$1)), [[vShow, pi !== unref(activeProfileIdx)]]);
							}), 128)) : tagMenuView.value === "color" && tagMenuButton.value && tagMenuButton.value.kind !== "spacer" ? (openBlock(), createBlock(LineColorSwatch_default, {
								key: 1,
								embedded: "",
								"model-value": tagMenuButton.value.color,
								"onUpdate:modelValue": updateTagColor
					...
					unref(showSearchPanel) ? (openBlock(), createElementBlock("div", _hoisted_42$1, [createBaseVNode("span", _hoisted_43$1, toDisplayString(unref(t)("tagbar.searchPanel")), 1), createVNode(SearchPanel_default, {
						"model-value": __props.searchText,
						editing: editing.value,
						"onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => emit("update:searchText", $event)),
						onAddToSearch: _cache[13] || (_cache[13] = ($event) => emit("addToSearch")),
						onSearch: _cache[14] || (_cache[14] = ($event) => emit("search", "search")),
						onDragStart: onTagStart,
						onDragEnd: onTagEnd
					}, null, 8, ["model-value", "editing"])])) : createCommentVNode("", true),
					createBaseVNode("div", _hoisted_44$1, [
						editing.value ? (openBlock(), createBlock(unref(draggableComponent), mergeProps({ key: 0 }, lineToolDragOptions, {
							"model-value": lineTools,
							"item-key": (tool) => tool.kind,
							clone: cloneTool,
							tag: "div",
							class: "eqt-tag-bar__line-add"
						}), {
							item: withCtx(({ element: tool }) => [createBaseVNode("div", _hoisted_45$1, [createVNode(unref(GripVertical), { size: 12 }), createTextVNode(" " + toDisplayString(unref(t)(tool.kind === "separator" ? "tagbar.addSeparatorLine" : "tagbar.addButtonLine")), 1)])]),
							_: 1
						}, 16, ["item-key"])) : createCommentVNode("", true),
						editing.value ? (openBlock(), createBlock(unref(draggableComponent), mergeProps({ key: 1 }, spacerToolDragOptions, {
							"model-value": spacerTools,
							"item-key": (tool) => tool.mode,
							clone: cloneTool,
							tag: "div",
							class: "eqt-tag-bar__item-add"
						}), {
							item: withCtx(({ element: tool }) => [createBaseVNode("div", _hoisted_46$1, [(openBlock(), createBlock(resolveDynamicComponent(tool.mode === "flex" ? unref(AlignHorizontalSpaceBetween) : unref(ArrowLeftRight)), { size: 12 })), createTextVNode(" " + toDisplayString(unref(t)(tool.mode === "flex" ? "tagbar.spacerModeFlex" : "tagbar.spacerModeFixed")), 1)])]),
							_: 1
						}, 16, ["item-key"])) : createCommentVNode("", true),
						createBaseVNode("div", _hoisted_47$1, [
							createBaseVNode("div", _hoisted_48$1, [createBaseVNode("button", {
								class: "eqt-tag-bar__ctrl-split-btn",
								type: "button",
								onClick: _cache[15] || (_cache[15] = ($event) => emit("add"))
							}, [createVNode(unref(Plus), { size: 12 }), createTextVNode(" " + toDisplayString(unref(t)("tagbar.addTag")), 1)]), createBaseVNode("button", {
								class: "eqt-tag-bar__ctrl-split-btn",
								type: "button",
								onClick: _cache[16] || (_cache[16] = ($event) => emit("addUrl"))
							}, [createVNode(unref(ExternalLink), { size: 12 }), createTextVNode(" " + toDisplayString(unref(t)("tagbar.addUrl")), 1)])]),
							createBaseVNode("button", {
								ref_key: "editToggleEl",
								ref: editToggleEl,
								class: normalizeClass(["eqt-tag-bar__ctrl eqt-tag-bar__ctrl--toggle", { "is-active": editing.value }]),
								type: "button",
								onClick: _cache[17] || (_cache[17] = ($event) => editing.value = !editing.value)
							...
							createBaseVNode("button", {
								...
								type: "button",
								onClick: _cache[18] || (_cache[18] = ($event) => emit("settings"))
	...
	var _hoisted_2$12 = { class: "eqt-popup__suggestion-ns" };
	var _hoisted_3$12 = { class: "eqt-popup__suggestion-name" };
	var _hoisted_4$12 = ["src"];
	var _hoisted_5$11 = { class: "eqt-popup__suggestion-tag" };
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", {
					...
					return openBlock(), createElementBlock("div", {
						...
						createBaseVNode("span", _hoisted_2$12, toDisplayString(unref(t)("ns." + entry.ns)) + "：", 1),
						createBaseVNode("span", _hoisted_3$12, [entry.iconUrl ? (openBlock(), createElementBlock("img", {
							key: 0,
							src: entry.iconUrl,
							class: "eqt-tag-icon",
							alt: ""
						}, null, 8, _hoisted_4$12)) : createCommentVNode("", true), createTextVNode(toDisplayString(isZh.value ? unref(zhDisplay)(entry.name) : entry.raw), 1)]),
						createBaseVNode("span", _hoisted_5$11, toDisplayString(entry.fullTag), 1)
					], 42, _hoisted_1$13);
				}), 128))], 4)], 36);
			};
		}
	...
	var TagAutocomplete_default = defineComponent({
		...
		setup(__props, { emit: __emit }) {
			...
			return (_ctx, _cache) => {
				return unref(dbReady) && __props.query.trim() && !unref(suggestions).length && !__props.qualifier ? (openBlock(), createElementBlock("div", _hoisted_1$12, toDisplayString(unref(t)("tagConfig.noResult")), 1)) : unref(suggestions).length ? (openBlock(), createBlock(SuggestionList_default, {
					key: 1,
	...
	var _hoisted_1$11 = { class: "eqt-row__builder" };
	var _hoisted_2$11 = ["title"];
	var _hoisted_3$11 = { class: "eqt-row__colon-split" };
	var _hoisted_4$11 = ["disabled", "title"];
	var _hoisted_5$10 = ["value"];
	var _hoisted_6$10 = { value: "" };
	var _hoisted_7$10 = ["label"];
	var _hoisted_8$8 = ["value"];
	var _hoisted_9$8 = ["label"];
	...
	var _hoisted_14$5 = ["title"];
	var _hoisted_15$5 = { class: "eqt-row__raw-line" };
	var _hoisted_16$5 = { class: "eqt-row__raw-label" };
	var SearchTermEditor_default = defineComponent({
		...
		setup(__props, { expose: __expose, emit: __emit }) {
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock(Fragment, null, [createBaseVNode("div", _hoisted_1$11, [
					createBaseVNode("button", {
					...
					}, toDisplayString(__props.rowState.token.prefix ?? "\xA0"), 11, _hoisted_2$11),
					createBaseVNode("div", _hoisted_3$11, [createBaseVNode("button", {
						...
						createBaseVNode("optgroup", { label: unref(t)("tagConfig.colonPrefixNsGroup") }, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(nsOptions), (opt) => {
							return openBlock(), createElementBlock("option", {
								key: opt.value,
								value: opt.value
							}, toDisplayString(opt.label), 9, _hoisted_8$8);
						}), 128))], 8, _hoisted_7$10),
					...
					createBaseVNode("div", _hoisted_11$7, [createBaseVNode("input", {
						...
						onFocus: onTagFocus,
						onBlur: onTagBlur
					}, null, 40, _hoisted_12$7), __props.active && __props.dbReady ? (openBlock(), createBlock(TagAutocomplete_default, {
						key: 0,
				...
				]), createBaseVNode("div", _hoisted_15$5, [createBaseVNode("label", _hoisted_16$5, toDisplayString(unref(t)("tagConfig.rawSyntax")), 1), createBaseVNode("div", {
					ref_key: "rawEl",
					ref: rawEl,
	...
	var _hoisted_1$10 = { class: "eqt-popup-overlay" };
	var _hoisted_2$10 = { class: "eqt-popup__body" };
	var _hoisted_3$10 = { class: "eqt-popup__field" };
	var _hoisted_4$10 = { class: "eqt-popup__label" };
	var _hoisted_5$9 = { class: "eqt-popup__field" };
	var _hoisted_6$9 = { class: "eqt-popup__label-row" };
	var _hoisted_7$9 = { class: "eqt-popup__label" };
	var _hoisted_8$7 = ["href"];
	var _hoisted_9$7 = {
		key: 0,
	...
	var _hoisted_12$6 = { class: "eqt-cycle-sim__label" };
	var _hoisted_13$5 = ["value"];
	var _hoisted_14$4 = { class: "eqt-cycle-modes" };
	var _hoisted_15$4 = { class: "eqt-cycle-group" };
	var _hoisted_16$4 = { class: "eqt-popup__label eqt-cycle-group__label" };
	var _hoisted_17$4 = { class: "eqt-cycle-group" };
	var _hoisted_18$4 = { class: "eqt-popup__label eqt-cycle-group__label" };
	var _hoisted_19$4 = ["disabled", "title"];
	var _hoisted_20$4 = ["checked"];
	var _hoisted_21$4 = ["disabled", "title"];
	var _hoisted_22$4 = ["checked"];
	var _hoisted_23$4 = {
		key: 0,
	...
	var TagConfigPopup_default = defineComponent({
		...
		setup(__props, { emit: __emit }) {
			...
			const isZh = computed(isZhLocale);
			const syntaxHelpUrl = computed(() => isZh.value ? "https://ehwiki.org/wiki/Gallery_Searching/Chinese" : "https://ehwiki.org/wiki/Gallery_Searching");
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", _hoisted_1$10, [createBaseVNode("div", {
					...
					createBaseVNode("div", _hoisted_3$10, [createBaseVNode("label", _hoisted_4$10, toDisplayString(unref(t)("tagConfig.displayName")), 1), createBaseVNode("div", { class: normalizeClass(["eqt-popup__field-row", unref(currentTagStyleClass)]) }, [createVNode(unref(_sfc_main), {
						tag: "span",
					...
					_cache[12] || (_cache[12] = createBaseVNode("hr", { class: "eqt-popup__divider" }, null, -1)),
					createBaseVNode("div", _hoisted_5$9, [createBaseVNode("div", _hoisted_6$9, [
						createBaseVNode("label", _hoisted_7$9, toDisplayString(unref(t)("tagConfig.tagSyntax")), 1),
						createBaseVNode("a", {
							class: "eqt-popup__syntax-help",
							href: syntaxHelpUrl.value,
							target: "_blank",
							rel: "noopener"
						}, [createVNode(unref(ExternalLink), { size: 12 }), _cache[5] || (_cache[5] = createTextVNode(" Wiki", -1))], 8, _hoisted_8$7),
						createBaseVNode("button", {
							class: "eqt-popup__add-btn",
							type: "button",
							onClick: _cache[1] || (_cache[1] = ($event) => addRowAfter(rows.length - 1))
					...
					buttonShape.value !== "empty" ? (openBlock(), createElementBlock("div", _hoisted_9$7, [
						...
						}, [createVNode(unref(MousePointerClick), { size: 13 }), createBaseVNode("span", null, toDisplayString(unref(t)("tagConfig.simulateOutput")), 1)]), createBaseVNode("span", _hoisted_12$6, toDisplayString(unref(t)("tagConfig.simulateCurrent", { state: simStateName.value })), 1)]), createBaseVNode("input", {
							type: "text",
						...
						createBaseVNode("div", _hoisted_14$4, [createBaseVNode("div", _hoisted_15$4, [createBaseVNode("span", _hoisted_16$4, toDisplayString(unref(t)("tagConfig.leftClickMode")), 1), _cache[6] || (_cache[6] = createBaseVNode("span", { class: "eqt-cycle-chip eqt-cycle-chip--include" }, "Include", -1))]), createBaseVNode("div", _hoisted_17$4, [
							createBaseVNode("span", _hoisted_18$4, toDisplayString(unref(t)("tagConfig.rightClickMode")), 1),
							createBaseVNode("button", {
								type: "button",
								...
								onClick: _cache[2] || (_cache[2] = ($event) => orShapeAllowed.value && (orEnabled.value = !orEnabled.value))
							...
							}, null, 8, _hoisted_20$4)), _cache[7] || (_cache[7] = createBaseVNode("span", null, "Or", -1))], 10, _hoisted_19$4),
							...
							createBaseVNode("button", {
								...
								onClick: _cache[3] || (_cache[3] = ($event) => excludeShapeAllowed.value && (excludeEnabled.value = !excludeEnabled.value))
								...
								tabindex: "-1",
								class: "eqt-cycle-chip__check"
							}, null, 8, _hoisted_22$4)), _cache[8] || (_cache[8] = createBaseVNode("span", null, "Exclude", -1))], 10, _hoisted_21$4)
						])]),
						cycleSkipReason.value ? (openBlock(), createElementBlock("p", _hoisted_23$4, toDisplayString(cycleSkipReason.value), 1)) : createCommentVNode("", true)
					])) : createCommentVNode("", true),
					createBaseVNode("div", _hoisted_24$3, [
						_cache[11] || (_cache[11] = createBaseVNode("div", { class: "eqt-popup__spacer" }, null, -1)),
						createBaseVNode("button", {
							class: "eqt-popup__btn",
							type: "button",
							onClick: _cache[4] || (_cache[4] = ($event) => emit("close"))
						}, [createTextVNode(toDisplayString(unref(t)("tagConfig.cancel")) + " ", 1), _cache[9] || (_cache[9] = createBaseVNode("kbd", { class: "eqt-popup__kbd" }, "Esc", -1))]),
						createBaseVNode("button", {
							class: "eqt-popup__btn eqt-popup__btn--green",
							type: "button",
							onClick: onSave
						}, [createTextVNode(toDisplayString(unref(t)("tagConfig.save")) + " ", 1), _cache[10] || (_cache[10] = createBaseVNode("kbd", { class: "eqt-popup__kbd" }, "Ctrl+Enter", -1))])
					])
				])], 512)]);
			};
		}
	...
	var ALL_CATEGORIES = EH_CATEGORIES.reduce((mask, c) => mask | c.bit, 0);
	function selectedFromFCats(fCats) {
		const excluded = fCats & ALL_CATEGORIES;
		return new Set(EH_CATEGORIES.map((c) => c.bit).filter((bit) => (excluded & bit) === 0));
	}
	function fCatsFromSelected(selected) {
		let mask = 0;
	...
	function buildSearchUrl(p, origin = EH_ORIGIN) {
		const base = toAbsoluteUrl(origin) ?? toAbsoluteUrl("https://e-hentai.org");
	...
	function parseSearchUrl(raw) {
		...
		return {
			...
			advanced: readAdvanced$1(q)
		};
	}
	function readAdvanced$1(q) {
		...
		return {
			...
			minRating: MIN_RATINGS.includes(rating) ? rating : "0",
	...
	function readAdvanced(form) {
		...
		if (MIN_RATINGS.includes(rating)) a.minRating = rating;
		return a;
	}
	function readEhSearchSnapshot() {
	...
	var _hoisted_1$9 = { class: "eqt-url-builder" };
	var _hoisted_2$9 = { class: "eqt-url-builder__field" };
	var _hoisted_3$9 = { class: "eqt-popup__label" };
	var _hoisted_4$9 = { class: "eqt-url-builder__row" };
	var _hoisted_5$8 = { class: "eqt-url-builder__field" };
	var _hoisted_6$8 = { class: "eqt-popup__label" };
	var _hoisted_7$8 = { class: "eqt-url-builder__cats" };
	var _hoisted_8$6 = [
		"data-disabled",
		"aria-pressed",
		"onClick"
	];
	var _hoisted_9$6 = { class: "eqt-url-builder__advanced" };
	var _hoisted_10$5 = { class: "eqt-url-builder__adv-row" };
	var _hoisted_11$5 = { class: "eqt-url-builder__check" };
	var _hoisted_12$5 = { class: "eqt-url-builder__adv-row" };
	var _hoisted_13$4 = { class: "eqt-url-builder__check" };
	var _hoisted_14$3 = { class: "eqt-url-builder__check" };
	var _hoisted_15$3 = { class: "eqt-url-builder__adv-row" };
	var _hoisted_16$3 = { class: "eqt-url-builder__adv-cell" };
	var _hoisted_17$3 = { class: "eqt-url-builder__adv-cell" };
	var _hoisted_18$3 = ["value"];
	var _hoisted_19$3 = { class: "eqt-url-builder__adv-row" };
	var _hoisted_20$3 = { class: "eqt-url-builder__adv-cell" };
	var _hoisted_21$3 = { class: "eqt-url-builder__check" };
	var _hoisted_22$3 = { class: "eqt-url-builder__check" };
	var _hoisted_23$3 = { class: "eqt-url-builder__check" };
	var UrlSearchBuilder_default = defineComponent({
		__name: "UrlSearchBuilder",
		props: { modelValue: {} },
		emits: ["update:modelValue"],
		setup(__props, { expose: __expose, emit: __emit }) {
			const props = __props;
			...
			watch(() => props.modelValue, (next) => {
				if (next === buildSearchUrl(currentParams(), "https://e-hentai.org")) return;
			...
			watch([
				...
				showAdvanced,
				advanced
			], () => emit("update:modelValue", buildSearchUrl(currentParams(), EH_ORIGIN)), { deep: true });
			...
			__expose({ useCurrentPage });
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", _hoisted_1$9, [
					createBaseVNode("div", _hoisted_2$9, [createBaseVNode("label", _hoisted_3$9, toDisplayString(unref(t)("urlBuilder.keywords")), 1), createBaseVNode("div", _hoisted_4$9, [withDirectives(createBaseVNode("input", {
						"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => keywords.value = $event),
						class: "eqt-popup__input"
					}, null, 512), [[vModelText, keywords.value]])])]),
					createBaseVNode("div", _hoisted_5$8, [createBaseVNode("label", _hoisted_6$8, toDisplayString(unref(t)("urlBuilder.categories")), 1), createBaseVNode("div", _hoisted_7$8, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(EH_CATEGORIES), (c) => {
						return openBlock(), createElementBlock("button", {
							key: c.bit,
							class: normalizeClass(["eqt-url-builder__cat cs", c.nativeClass]),
							"data-disabled": categories.value.has(c.bit) ? void 0 : "1",
							type: "button",
							"aria-pressed": categories.value.has(c.bit),
							onClick: ($event) => toggleCategory(c.bit)
						}, toDisplayString(unref(t)(`category.${c.key}`)), 11, _hoisted_8$6);
					}), 128))])]),
					createBaseVNode("div", _hoisted_9$6, [
						createBaseVNode("div", _hoisted_10$5, [createBaseVNode("label", _hoisted_11$5, [withDirectives(createBaseVNode("input", {
							type: "checkbox",
							"onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => showAdvanced.value = $event)
						}, null, 512), [[vModelCheckbox, showAdvanced.value]]), createBaseVNode("span", null, toDisplayString(unref(t)("urlBuilder.showAdvanced")), 1)])]),
						createBaseVNode("div", _hoisted_12$5, [createBaseVNode("label", _hoisted_13$4, [withDirectives(createBaseVNode("input", {
							type: "checkbox",
							"onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => advanced.value.browseExpunged = $event)
						}, null, 512), [[vModelCheckbox, advanced.value.browseExpunged]]), createBaseVNode("span", null, toDisplayString(unref(t)("urlBuilder.browseExpunged")), 1)]), createBaseVNode("label", _hoisted_14$3, [withDirectives(createBaseVNode("input", {
							type: "checkbox",
							"onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => advanced.value.requireTorrent = $event)
						}, null, 512), [[vModelCheckbox, advanced.value.requireTorrent]]), createBaseVNode("span", null, toDisplayString(unref(t)("urlBuilder.requireTorrent")), 1)])]),
						createBaseVNode("div", _hoisted_15$3, [createBaseVNode("span", _hoisted_16$3, [
							createTextVNode(toDisplayString(unref(t)("urlBuilder.pagesBetween")) + " ", 1),
							withDirectives(createBaseVNode("input", {
								"onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => advanced.value.pagesFrom = $event),
								class: "eqt-url-builder__num",
								maxlength: "4",
								inputmode: "numeric"
							}, null, 512), [[vModelText, advanced.value.pagesFrom]]),
							createTextVNode(" " + toDisplayString(unref(t)("urlBuilder.pagesAnd")) + " ", 1),
							withDirectives(createBaseVNode("input", {
								"onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => advanced.value.pagesTo = $event),
								class: "eqt-url-builder__num",
								maxlength: "4",
								inputmode: "numeric"
							}, null, 512), [[vModelText, advanced.value.pagesTo]]),
							createTextVNode(" " + toDisplayString(unref(t)("urlBuilder.pagesUnit")), 1)
						]), createBaseVNode("span", _hoisted_17$3, [createTextVNode(toDisplayString(unref(t)("urlBuilder.minRating")) + " ", 1), withDirectives(createBaseVNode("select", {
							"onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => advanced.value.minRating = $event),
							class: "eqt-url-builder__select"
						}, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(MIN_RATINGS), (r) => {
							return openBlock(), createElementBlock("option", {
								key: r,
								value: r
							}, toDisplayString(r === "0" ? unref(t)("urlBuilder.anyRating") : unref(t)("urlBuilder.stars").replace("{n}", r)), 9, _hoisted_18$3);
						}), 128))], 512), [[vModelSelect, advanced.value.minRating]])])]),
						createBaseVNode("div", _hoisted_19$3, [
							createBaseVNode("span", _hoisted_20$3, toDisplayString(unref(t)("urlBuilder.disableFilters")), 1),
							createBaseVNode("label", _hoisted_21$3, [withDirectives(createBaseVNode("input", {
								type: "checkbox",
								"onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => advanced.value.disableFilterLanguage = $event)
							}, null, 512), [[vModelCheckbox, advanced.value.disableFilterLanguage]]), createBaseVNode("span", null, toDisplayString(unref(t)("urlBuilder.filterLanguage")), 1)]),
							createBaseVNode("label", _hoisted_22$3, [withDirectives(createBaseVNode("input", {
								type: "checkbox",
								"onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => advanced.value.disableFilterUploader = $event)
							}, null, 512), [[vModelCheckbox, advanced.value.disableFilterUploader]]), createBaseVNode("span", null, toDisplayString(unref(t)("urlBuilder.filterUploader")), 1)]),
							createBaseVNode("label", _hoisted_23$3, [withDirectives(createBaseVNode("input", {
								type: "checkbox",
								"onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => advanced.value.disableFilterTags = $event)
							}, null, 512), [[vModelCheckbox, advanced.value.disableFilterTags]]), createBaseVNode("span", null, toDisplayString(unref(t)("urlBuilder.filterTags")), 1)])
						])
					])
				]);
			};
	...
	var _hoisted_8$5 = ["disabled"];
	var _hoisted_9$5 = { class: "eqt-popup__actions" };
	var UrlConfigPopup_default = defineComponent({
		...
		setup(__props, { emit: __emit }) {
			...
			watch(() => props.tag, (t) => {
				label.value = t.label ?? "";
				color.value = t.color;
				url.value = t.url ? toAbsoluteUrl(t.url)?.href ?? t.url : "";
			}, { immediate: true });
			let abortFetch = null;
			...
			function onSave() {
				...
				emit("save", {
					kind: "url",
					url: toAbsoluteUrl(trimmedUrl)?.href ?? trimmedUrl,
					label: label.value.trim() || void 0,
					color: color.value
				});
			}
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", _hoisted_1$8, [createBaseVNode("div", {
					...
					_cache[8] || (_cache[8] = createBaseVNode("hr", { class: "eqt-popup__divider" }, null, -1)),
					createBaseVNode("div", _hoisted_5$7, [createBaseVNode("label", _hoisted_6$7, toDisplayString(unref(t)("urlConfig.url")), 1), createBaseVNode("div", _hoisted_7$7, [withDirectives(createBaseVNode("input", {
						"onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => url.value = $event),
						class: "eqt-popup__input",
						placeholder: "https://..."
					}, null, 512), [[vModelText, url.value]]), createBaseVNode("button", {
						class: "eqt-popup__btn",
						type: "button",
						disabled: fetchingTitle.value || !url.value.trim(),
						onClick: fetchTitle
					}, toDisplayString(fetchingTitle.value ? unref(t)("urlConfig.fetching") : unref(t)("urlConfig.fetchTitle")), 9, _hoisted_8$5)])]),
					builderApplicable.value ? (openBlock(), createBlock(UrlSearchBuilder_default, {
						key: 0,
						ref_key: "builderRef",
						ref: builderRef,
					...
					createBaseVNode("div", _hoisted_9$5, [
						builderApplicable.value && snapshotAvailable ? (openBlock(), createElementBlock("button", {
							key: 0,
							class: "eqt-popup__btn",
							type: "button",
							onClick: _cache[3] || (_cache[3] = ($event) => builderRef.value?.useCurrentPage())
						}, [createVNode(unref(Star), { size: 12 }), createTextVNode(" " + toDisplayString(unref(t)("urlBuilder.useCurrentPage")), 1)])) : createCommentVNode("", true),
						_cache[7] || (_cache[7] = createBaseVNode("div", { class: "eqt-popup__spacer" }, null, -1)),
						createBaseVNode("button", {
							class: "eqt-popup__btn",
							type: "button",
							onClick: _cache[4] || (_cache[4] = ($event) => emit("close"))
						}, [createTextVNode(toDisplayString(unref(t)("urlConfig.cancel")) + " ", 1), _cache[5] || (_cache[5] = createBaseVNode("kbd", { class: "eqt-popup__kbd" }, "Esc", -1))]),
						createBaseVNode("button", {
							class: "eqt-popup__btn eqt-popup__btn--green",
							type: "button",
							onClick: onSave
						}, [createTextVNode(toDisplayString(unref(t)("urlConfig.save")) + " ", 1), _cache[6] || (_cache[6] = createBaseVNode("kbd", { class: "eqt-popup__kbd" }, "Ctrl+Enter", -1))])
					])
				])], 512)]);
			};
		}
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", _hoisted_1$6, [
					...
					editorPreview.value ? (openBlock(), createElementBlock("div", {
						...
						return openBlock(), createElementBlock(Fragment, { key: li }, [line.kind === "buttons" && line.buttons.some((b) => b.kind !== "spacer") ? (openBlock(), createElementBlock("div", {
							key: 0,
							class: "eqt-settings__preview-line",
							style: normalizeStyle({ justifyContent: unref(textAlignToJustify)(line.style?.textAlign ?? unref(buttonLineTextAlign)) })
						}, [(openBlock(true), createElementBlock(Fragment, null, renderList(line.buttons, (b, ti) => {
							return openBlock(), createElementBlock(Fragment, { key: ti }, [b.kind !== "spacer" ? (openBlock(), createElementBlock("span", {
								key: 0,
								class: normalizeClass(["eqt-settings__preview-tag", { "eqt-settings__preview-tag--url": b.kind === "url" }])
							}, toDisplayString(unref(buttonPreviewLabel)(b) || unref(t)("settings.emptyTag")), 3)) : createCommentVNode("", true)], 64);
						}), 128))], 4)) : createCommentVNode("", true)], 64);
					...
					}, null, 8, _hoisted_7$6), [[vModelText, editorText.value]]),
					editorError.value ? (openBlock(), createElementBlock("p", _hoisted_8$4, toDisplayString(unref(t)("settings.editorJsonError", { message: editorError.value })), 1)) : createCommentVNode("", true),
					__props.mode === "corrupted" ? (openBlock(), createElementBlock("div", _hoisted_9$4, [__props.corruptedReason ? (openBlock(), createElementBlock("p", _hoisted_10$4, toDisplayString(unref(t)("settings.corruptedReason", { reason: __props.corruptedReason })), 1)) : createCommentVNode("", true), createBaseVNode("button", {
						class: "eqt-popup__btn eqt-popup__btn--delete",
						type: "button",
						onClick: _cache[1] || (_cache[1] = ($event) => emit("purge"))
					}, toDisplayString(unref(t)("settings.purgeProfile")), 1)])) : __props.mode === "deleted" ? (openBlock(), createElementBlock("div", _hoisted_11$4, [createBaseVNode("button", {
						class: "eqt-popup__btn eqt-popup__btn--green",
						type: "button",
					...
					}, toDisplayString(unref(t)("settings.purgeProfile")), 1)])) : (openBlock(), createElementBlock("div", _hoisted_12$4, [_cache[4] || (_cache[4] = createBaseVNode("div", { class: "eqt-popup__spacer" }, null, -1)), createBaseVNode("button", {
						class: "eqt-popup__btn eqt-popup__btn--green",
						type: "button",
	...
	var _hoisted_8$2 = { class: "eqt-settings__section" };
	var _hoisted_9$2 = { class: "eqt-settings__subtitle" };
	var _hoisted_10$2 = { class: "eqt-settings__row" };
	var _hoisted_11$2 = ["checked"];
	var _hoisted_12$2 = { class: "eqt-settings__label" };
	var _hoisted_13$2 = { class: "eqt-settings__field-row eqt-settings__field-row--sub" };
	var _hoisted_14$1 = { class: "eqt-settings__field-label" };
	var _hoisted_15$1 = { class: "eqt-settings__locale-row" };
	var _hoisted_16$1 = ["disabled", "onClick"];
	var _hoisted_17$1 = { class: "eqt-settings__row" };
	var _hoisted_18$1 = ["checked"];
	var _hoisted_19$1 = { class: "eqt-settings__label" };
	var _hoisted_20$1 = { class: "eqt-settings__section" };
	var _hoisted_21$1 = { class: "eqt-settings__subtitle" };
	var _hoisted_22$1 = { class: "eqt-settings__field-row" };
	var _hoisted_23$1 = { class: "eqt-settings__field-label" };
	var _hoisted_24$1 = { class: "eqt-settings__locale-row" };
	var _hoisted_25 = { class: "eqt-settings__row" };
	var _hoisted_26 = ["checked"];
	var _hoisted_27 = { class: "eqt-settings__label" };
	var _hoisted_28 = { class: "eqt-settings__hint" };
	var _hoisted_29 = { class: "eqt-settings__section" };
	var _hoisted_30 = { class: "eqt-settings__subtitle" };
	var _hoisted_31 = { class: "eqt-settings__field-label eqt-settings__field-label--aligned" };
	var _hoisted_32 = ["value", "onChange"];
	var _hoisted_33 = { value: "search" };
	var _hoisted_34 = { value: "searchNewTab" };
	var _hoisted_35 = { value: "clearSearch" };
	var _hoisted_36 = { value: "toggleEdit" };
	var _hoisted_37 = { value: "openSearchPopup" };
	var _hoisted_38 = { value: "none" };
	var _hoisted_39 = {
		key: 0,
		class: "eqt-settings__row"
	};
	var _hoisted_40 = ["checked", "onChange"];
	var _hoisted_41 = { class: "eqt-settings__label" };
	var _hoisted_42 = { class: "eqt-settings__section" };
	var _hoisted_43 = { class: "eqt-settings__subtitle" };
	var _hoisted_44 = { class: "eqt-settings__row" };
	var _hoisted_45 = ["checked"];
	var _hoisted_46 = { class: "eqt-settings__label" };
	var _hoisted_47 = { class: "eqt-settings__section" };
	var _hoisted_48 = { class: "eqt-settings__subtitle" };
	var _hoisted_49 = { class: "eqt-settings__locale-row" };
	var _hoisted_50 = ["onClick"];
	var _hoisted_51 = { class: "eqt-settings__row" };
	var _hoisted_52 = ["checked"];
	var _hoisted_53 = { class: "eqt-settings__label" };
	var _hoisted_54 = { class: "eqt-settings__hint" };
	var _hoisted_55 = { class: "eqt-settings__section" };
	var _hoisted_56 = { class: "eqt-settings__subtitle" };
	var _hoisted_57 = { class: "eqt-settings__field-label" };
	var _hoisted_58 = { class: "eqt-settings__locale-row" };
	var _hoisted_59 = ["onClick"];
	var _hoisted_60 = { class: "eqt-settings__section" };
	var _hoisted_61 = { class: "eqt-settings__subtitle" };
	var _hoisted_62 = { class: "eqt-settings__tab-content" };
	var _hoisted_63 = { class: "eqt-settings__section" };
	var _hoisted_64 = { class: "eqt-settings__subtitle" };
	var _hoisted_65 = { class: "eqt-settings__row" };
	var _hoisted_66 = ["checked"];
	var _hoisted_67 = { class: "eqt-settings__label" };
	var _hoisted_68 = { class: "eqt-settings__hint" };
	var _hoisted_69 = { class: "eqt-settings__row" };
	var _hoisted_70 = ["checked", "disabled"];
	var _hoisted_71 = { class: "eqt-settings__label" };
	var _hoisted_72 = { class: "eqt-settings__hint" };
	var _hoisted_73 = { class: "eqt-settings__section" };
	var _hoisted_74 = { class: "eqt-settings__subtitle" };
	var _hoisted_75 = { class: "eqt-settings__field-row" };
	var _hoisted_76 = { class: "eqt-settings__field-label" };
	var _hoisted_77 = ["disabled", "title"];
	var _hoisted_78 = { class: "eqt-settings__row" };
	var _hoisted_79 = ["checked", "disabled"];
	var _hoisted_80 = { class: "eqt-settings__label" };
	var _hoisted_81 = { class: "eqt-settings__hint" };
	var _hoisted_82 = {
		href: "https://e-hentai.org/g/760051/e601ae7b84/",
		target: "_blank",
		rel: "noopener noreferrer"
	};
	var _hoisted_83 = { class: "eqt-settings__field-row" };
	var _hoisted_84 = { class: "eqt-settings__field-label" };
	var _hoisted_85 = ["disabled", "title"];
	var _hoisted_86 = { class: "eqt-settings__label" };
	var _hoisted_87 = { class: "eqt-settings__gallery-preview" };
	var _hoisted_88 = { class: "eqt-settings__section" };
	var _hoisted_89 = { class: "eqt-settings__subtitle" };
	var _hoisted_90 = { class: "eqt-settings__field-label eqt-settings__field-label--aligned" };
	var _hoisted_91 = [
		"value",
		"disabled",
		"onChange"
	...
	var _hoisted_95 = { class: "eqt-settings__label" };
	var _hoisted_96 = { class: "eqt-settings__section" };
	var _hoisted_97 = { class: "eqt-settings__subtitle" };
	var _hoisted_98 = { class: "eqt-settings__field-row" };
	var _hoisted_99 = { class: "eqt-settings__field-label" };
	var _hoisted_100 = { class: "eqt-settings__locale-row" };
	var _hoisted_101 = ["onClick"];
	var _hoisted_102 = { class: "eqt-settings__hint" };
	var _hoisted_103 = { class: "eqt-settings__row" };
	var _hoisted_104 = ["checked", "disabled"];
	var _hoisted_105 = { class: "eqt-settings__label" };
	var _hoisted_106 = { class: "eqt-settings__hint" };
	var _hoisted_107 = { class: "eqt-settings__tab-content" };
	var _hoisted_108 = { class: "eqt-settings__section" };
	var _hoisted_109 = { class: "eqt-settings__subtitle" };
	var _hoisted_110 = { class: "eqt-settings__row" };
	var _hoisted_111 = ["title"];
	var _hoisted_112 = ["value"];
	var _hoisted_113 = ["title"];
	var _hoisted_114 = ["disabled"];
	var _hoisted_115 = { class: "eqt-settings__row" };
	var _hoisted_116 = ["value"];
	var _hoisted_117 = { class: "eqt-settings__section" };
	var _hoisted_118 = { class: "eqt-settings__subtitle" };
	var _hoisted_119 = { class: "eqt-settings__row" };
	var _hoisted_120 = ["title"];
	var _hoisted_121 = ["value"];
	var _hoisted_122 = ["title"];
	var _hoisted_123 = ["disabled"];
	var _hoisted_124 = { class: "eqt-settings__row" };
	var _hoisted_125 = ["value"];
	var _hoisted_126 = { class: "eqt-settings__section" };
	var _hoisted_127 = { class: "eqt-settings__subtitle" };
	var _hoisted_128 = { class: "eqt-settings__row" };
	var _hoisted_129 = ["title"];
	var _hoisted_130 = ["value"];
	var _hoisted_131 = ["title"];
	var _hoisted_132 = ["disabled"];
	var _hoisted_133 = { class: "eqt-settings__row" };
	var _hoisted_134 = ["value"];
	var _hoisted_135 = { class: "eqt-settings__tab-content" };
	var _hoisted_136 = { class: "eqt-settings__section" };
	var _hoisted_137 = { class: "eqt-settings__subtitle" };
	var _hoisted_138 = { class: "eqt-settings__locale-row" };
	var _hoisted_139 = ["onClick"];
	var _hoisted_140 = { class: "eqt-settings__hint" };
	var _hoisted_141 = { class: "eqt-settings__section" };
	var _hoisted_142 = { class: "eqt-settings__subtitle" };
	var _hoisted_143 = { class: "eqt-settings__locale-row" };
	var _hoisted_144 = ["onClick"];
	var _hoisted_145 = { class: "eqt-settings__hint" };
	var _hoisted_146 = { class: "eqt-settings__section" };
	var _hoisted_147 = { class: "eqt-settings__subtitle" };
	var _hoisted_148 = { class: "eqt-settings__font-row" };
	var _hoisted_149 = ["value", "placeholder"];
	var _hoisted_150 = { class: "eqt-settings__hint" };
	var _hoisted_151 = { class: "eqt-settings__field-row" };
	var _hoisted_152 = { class: "eqt-settings__field-label" };
	var _hoisted_153 = ["value"];
	var _hoisted_154 = { class: "eqt-settings__weight-value" };
	var _hoisted_155 = { class: "eqt-settings__section" };
	var _hoisted_156 = { class: "eqt-settings__subtitle" };
	var _hoisted_157 = { class: "eqt-settings__profiles" };
	var _hoisted_158 = { class: "eqt-settings__subtitle" };
	var _hoisted_159 = { class: "eqt-settings__subtitle" };
	var _hoisted_160 = { class: "eqt-settings__ns-list" };
	var _hoisted_161 = { class: "eqt-settings__subtitle" };
	var _hoisted_162 = { class: "eqt-settings__ns-list" };
	var SettingsPopup_default = defineComponent({
		...
		setup(__props, { emit: __emit }) {
			...
			const activeTab = ref(narrowTab(props.initialTab) ?? "general");
			const dblClickOptions = [{
				labelKey: "settings.dblClickLeft",
				ref: dblClickLeft,
				newTabRef: dblClickLeftNewTabActive
			}, {
				labelKey: "settings.dblClickRight",
				ref: dblClickRight,
				newTabRef: dblClickRightNewTabActive
			}];
			const galleryDblClickOptions = [{
				labelKey: "settings.galleryDblClickLeft",
				ref: galleryDblClickLeft,
				newTabRef: galleryDblClickLeftNewTabActive
			}, {
				labelKey: "settings.galleryDblClickRight",
				ref: galleryDblClickRight,
				newTabRef: galleryDblClickRightNewTabActive
			}];
			const lineAlignSettings = [{
				labelKey: "settings.buttonLineTextAlign",
				ref: buttonLineTextAlign
			}, {
				labelKey: "settings.separatorLineTextAlign",
				ref: separatorLineTextAlign
			}];
			const localeOptions = [
				{
					value: "zh-TW",
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock("div", _hoisted_1$4, [createBaseVNode("div", {
					...
					createBaseVNode("nav", _hoisted_2$4, [
						...
						_cache[22] || (_cache[22] = createBaseVNode("div", { class: "eqt-settings__sidebar-spacer" }, null, -1)),
						createBaseVNode("button", {
					...
					createBaseVNode("div", _hoisted_5$4, [withDirectives(createBaseVNode("div", _hoisted_6$4, [
						withDirectives(createBaseVNode("div", _hoisted_7$4, [
							createBaseVNode("section", _hoisted_8$2, [
								createBaseVNode("h4", _hoisted_9$2, [createVNode(unref(LayoutPanelTop), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("settings.searchBarVisibility")), 1)]),
								createBaseVNode("label", _hoisted_10$2, [createBaseVNode("input", {
									type: "checkbox",
									checked: unref(showSearchPanel),
									onChange: _cache[1] || (_cache[1] = ($event) => showSearchPanel.value = $event.target.checked)
								}, null, 40, _hoisted_11$2), createBaseVNode("span", _hoisted_12$2, toDisplayString(unref(t)("settings.showSearchPanel")), 1)]),
								createBaseVNode("div", _hoisted_13$2, [createBaseVNode("label", _hoisted_14$1, toDisplayString(unref(t)("settings.searchPanelLang")), 1), createBaseVNode("div", _hoisted_15$1, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(SEARCH_PANEL_LANG_MODES), (m) => {
									return openBlock(), createElementBlock("button", {
										key: m.id,
										type: "button",
										class: normalizeClass(["eqt-settings__locale-btn", { "eqt-settings__locale-btn--active": unref(searchPanelLangMode) === m.id }]),
										disabled: !unref(showSearchPanel),
										onClick: ($event) => searchPanelLangMode.value = m.id
									}, toDisplayString(unref(t)(m.labelKey)), 11, _hoisted_16$1);
								}), 128))])]),
								createBaseVNode("label", _hoisted_17$1, [createBaseVNode("input", {
									type: "checkbox",
									checked: unref(enableHistory),
									onChange: _cache[2] || (_cache[2] = ($event) => enableHistory.value = $event.target.checked)
								}, null, 40, _hoisted_18$1), createBaseVNode("span", _hoisted_19$1, toDisplayString(unref(t)("settings.enableHistory")), 1)])
							]),
							createBaseVNode("section", _hoisted_20$1, [
								createBaseVNode("h4", _hoisted_21$1, [createVNode(unref(Tag), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("settings.sectionTagFormat")), 1)]),
								createBaseVNode("div", _hoisted_22$1, [createBaseVNode("label", _hoisted_23$1, toDisplayString(unref(t)("settings.nsFormat")), 1), createBaseVNode("div", _hoisted_24$1, [createBaseVNode("button", {
									type: "button",
								...
								createBaseVNode("label", _hoisted_25, [createBaseVNode("input", {
									type: "checkbox",
									checked: unref(defaultExactMatch),
									onChange: _cache[5] || (_cache[5] = ($event) => defaultExactMatch.value = $event.target.checked)
								}, null, 40, _hoisted_26), createBaseVNode("span", _hoisted_27, toDisplayString(unref(t)("settings.defaultExactMatch")), 1)]),
								createBaseVNode("p", _hoisted_28, toDisplayString(unref(t)("settings.defaultExactMatchHint")), 1)
							]),
							createBaseVNode("section", _hoisted_29, [createBaseVNode("h4", _hoisted_30, [createVNode(unref(MousePointerClick), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("settings.dblClickActions")), 1)]), (openBlock(), createElementBlock(Fragment, null, renderList(dblClickOptions, ({ labelKey, ref: r, newTabRef }) => {
								return createBaseVNode("div", {
									key: labelKey,
									class: "eqt-settings__field-row"
								}, [
									createBaseVNode("label", _hoisted_31, toDisplayString(unref(t)(labelKey)), 1),
									createBaseVNode("select", {
										class: "eqt-settings__select",
										value: r.value,
										onChange: ($event) => r.value = $event.target.value
									}, [
										createBaseVNode("option", _hoisted_33, toDisplayString(unref(t)("settings.actionSearchCurrent")), 1),
										createBaseVNode("option", _hoisted_34, toDisplayString(unref(t)("settings.actionSearchNewTab")), 1),
										createBaseVNode("option", _hoisted_35, toDisplayString(unref(t)("settings.actionClear")), 1),
										createBaseVNode("option", _hoisted_36, toDisplayString(unref(t)("settings.actionToggleEdit")), 1),
										createBaseVNode("option", _hoisted_37, toDisplayString(unref(t)("settings.actionOpenSearchPopup")), 1),
										createBaseVNode("option", _hoisted_38, toDisplayString(unref(t)("settings.actionNone")), 1)
									], 40, _hoisted_32),
									r.value === "searchNewTab" ? (openBlock(), createElementBlock("label", _hoisted_39, [createBaseVNode("input", {
										type: "checkbox",
										checked: newTabRef.value,
										onChange: ($event) => newTabRef.value = $event.target.checked
									}, null, 40, _hoisted_40), createBaseVNode("span", _hoisted_41, toDisplayString(unref(t)("settings.newTabActivate")), 1)])) : createCommentVNode("", true)
								]);
							}), 64))]),
							createBaseVNode("section", _hoisted_42, [createBaseVNode("h4", _hoisted_43, [createVNode(unref(ExternalLink), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("settings.sectionUrlButton")), 1)]), createBaseVNode("label", _hoisted_44, [createBaseVNode("input", {
								type: "checkbox",
								checked: unref(followCurrentSite),
								onChange: _cache[6] || (_cache[6] = ($event) => followCurrentSite.value = $event.target.checked)
							}, null, 40, _hoisted_45), createBaseVNode("span", _hoisted_46, toDisplayString(unref(t)("settings.followCurrentSite")), 1)])]),
							createBaseVNode("section", _hoisted_47, [
								createBaseVNode("h4", _hoisted_48, [createVNode(unref(Palette), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("settings.tagStyle")), 1)]),
								createBaseVNode("div", _hoisted_49, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(TAG_STYLE_PRESETS), (preset) => {
									return openBlock(), createElementBlock("button", {
										key: preset.id,
										type: "button",
									...
									}, toDisplayString(unref(t)(preset.labelKey)), 11, _hoisted_50);
								}), 128))]),
								createBaseVNode("label", _hoisted_51, [createBaseVNode("input", {
									type: "checkbox",
									checked: unref(useAccentOnInclude),
									onChange: _cache[7] || (_cache[7] = ($event) => useAccentOnInclude.value = $event.target.checked)
								}, null, 40, _hoisted_52), createBaseVNode("span", _hoisted_53, toDisplayString(unref(t)("settings.useAccentOnInclude")), 1)]),
								createBaseVNode("p", _hoisted_54, toDisplayString(unref(t)("settings.useAccentOnIncludeHint")), 1)
							]),
							createBaseVNode("section", _hoisted_55, [createBaseVNode("h4", _hoisted_56, [createVNode(unref(LayoutPanelTop), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("settings.sectionLineAlignment")), 1)]), (openBlock(), createElementBlock(Fragment, null, renderList(lineAlignSettings, (row) => {
								return createBaseVNode("div", {
									key: row.labelKey,
									class: "eqt-settings__field-row"
								}, [createBaseVNode("label", _hoisted_57, toDisplayString(unref(t)(row.labelKey)), 1), createBaseVNode("div", _hoisted_58, [(openBlock(), createElementBlock(Fragment, null, renderList([
									"left",
									"center",
									"right"
								], (align) => {
									return createBaseVNode("button", {
										key: align,
										type: "button",
										class: normalizeClass(["eqt-settings__locale-btn", { "eqt-settings__locale-btn--active": row.ref.value === align }]),
										onClick: ($event) => row.ref.value = align
									}, toDisplayString(unref(t)(`tagbar.separatorTextAlign_${align}`)), 11, _hoisted_59);
								}), 64))])]);
							}), 64))]),
							createBaseVNode("section", _hoisted_60, [createBaseVNode("h4", _hoisted_61, [createVNode(unref(Eye), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("settings.preview")), 1)]), createBaseVNode("div", { class: normalizeClass(["eqt-settings__font-preview", unref(currentTagStyleClass)]) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(previewLines.value, (line, li) => {
								return openBlock(), createElementBlock(Fragment, { key: li }, [line.kind === "buttons" && line.buttons.some((b) => b.kind !== "spacer") ? (openBlock(), createElementBlock("div", {
									key: 0,
									class: "eqt-settings__preview-line",
									style: normalizeStyle({ justifyContent: unref(textAlignToJustify)(line.style?.textAlign ?? unref(buttonLineTextAlign)) })
									...
									return openBlock(), createElementBlock(Fragment, { key: ti }, [b.kind !== "spacer" ? (openBlock(), createElementBlock("span", {
										key: 0,
										class: normalizeClass(["eqt-settings__preview-tag", { "eqt-settings__preview-tag--url": b.kind === "url" }])
									}, toDisplayString(unref(buttonPreviewLabel)(b)), 3)) : createCommentVNode("", true)], 64);
								}), 128))], 4)) : createCommentVNode("", true)], 64);
							}), 128))], 2)])
						], 512), [[vShow, activeTab.value === "tagbar"]]),
						withDirectives(createBaseVNode("div", _hoisted_62, [
							createBaseVNode("section", _hoisted_63, [
								createBaseVNode("h4", _hoisted_64, [createVNode(unref(ToggleLeft), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("settings.sectionGalleryToggles")), 1)]),
								createBaseVNode("label", _hoisted_65, [createBaseVNode("input", {
									type: "checkbox",
									checked: unref(taggingEnhancerEnabled),
									onChange: _cache[8] || (_cache[8] = ($event) => taggingEnhancerEnabled.value = $event.target.checked)
								}, null, 40, _hoisted_66), createBaseVNode("span", _hoisted_67, toDisplayString(unref(t)("settings.taggingEnhancer")), 1)]),
								createBaseVNode("p", _hoisted_68, toDisplayString(unref(t)("settings.taggingEnhancerHint")), 1),
								createBaseVNode("label", _hoisted_69, [createBaseVNode("input", {
									type: "checkbox",
									checked: unref(galleryDragSelectEnabled),
									disabled: !unref(taggingEnhancerEnabled),
									onChange: _cache[9] || (_cache[9] = ($event) => galleryDragSelectEnabled.value = $event.target.checked)
								}, null, 40, _hoisted_70), createBaseVNode("span", _hoisted_71, toDisplayString(unref(t)("settings.galleryDragSelect")), 1)]),
								createBaseVNode("p", _hoisted_72, toDisplayString(unref(t)("settings.galleryDragSelectHint")), 1)
							]),
							createBaseVNode("section", _hoisted_73, [
								createBaseVNode("h4", _hoisted_74, [createVNode(unref(UnfoldVertical), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("settings.sectionGallerySize")), 1)]),
								createBaseVNode("div", _hoisted_75, [
									createBaseVNode("label", _hoisted_76, toDisplayString(unref(t)("settings.galleryTaglistHeight")), 1),
									withDirectives(createBaseVNode("input", {
										...
										step: "10",
										disabled: !unref(taggingEnhancerEnabled),
										"onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => isRef(galleryTaglistHeight) ? galleryTaglistHeight.value = $event : null),
										title: unref(t)("settings.galleryTaglistHeight")
									}, null, 8, _hoisted_77), [[
										vModelText,
										unref(galleryTaglistHeight),
										void 0,
										{ number: true }
									]]),
									_cache[23] || (_cache[23] = createBaseVNode("span", { class: "eqt-settings__label" }, "px", -1))
								]),
								createBaseVNode("label", _hoisted_78, [createBaseVNode("input", {
									type: "checkbox",
									checked: unref(galleryTaglistExpand),
									disabled: !unref(taggingEnhancerEnabled),
									onChange: _cache[11] || (_cache[11] = ($event) => galleryTaglistExpand.value = $event.target.checked)
								}, null, 40, _hoisted_79), createBaseVNode("span", _hoisted_80, toDisplayString(unref(t)("settings.galleryTaglistExpand")), 1)]),
								createBaseVNode("p", _hoisted_81, [
									createTextVNode(toDisplayString(unref(t)("settings.galleryTaglistHeightTipBefore")), 1),
									createBaseVNode("a", _hoisted_82, toDisplayString(unref(t)("settings.galleryTaglistHeightTipLink")), 1),
									createTextVNode(toDisplayString(unref(t)("settings.galleryTaglistHeightTipAfter")), 1)
								]),
								createBaseVNode("div", _hoisted_83, [
									createBaseVNode("label", _hoisted_84, toDisplayString(unref(t)("settings.galleryTaglistZoom")), 1),
									withDirectives(createBaseVNode("input", {
										...
										step: "5",
										disabled: !unref(taggingEnhancerEnabled),
										"onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => isRef(galleryTaglistZoom) ? galleryTaglistZoom.value = $event : null),
										title: unref(t)("settings.galleryTaglistZoom")
									}, null, 8, _hoisted_85), [[
										vModelText,
										unref(galleryTaglistZoom),
										void 0,
										{ number: true }
									]]),
									createBaseVNode("span", _hoisted_86, toDisplayString(unref(galleryTaglistZoom)) + "%", 1)
								]),
								createBaseVNode("div", _hoisted_87, [createBaseVNode("div", {
									class: "eqt-gallery-taglist",
									style: normalizeStyle({ zoom: unref(galleryTaglistZoom) / 100 })
								}, [..._cache[24] || (_cache[24] = [createStaticVNode("<div class=\"eqt-gallery-taglist__row\"><div class=\"eqt-gallery-taglist__label\">language:</div><div class=\"eqt-gallery-taglist__cells\"><div class=\"eqt-gallery-chip eqt-gallery-chip--gt\"><span class=\"eqt-gallery-chip__body\">chinese</span></div><div class=\"eqt-gallery-chip eqt-gallery-chip--gt\"><span class=\"eqt-gallery-chip__body\">translated</span></div></div></div><div class=\"eqt-gallery-taglist__row\"><div class=\"eqt-gallery-taglist__label\">other:</div><div class=\"eqt-gallery-taglist__cells\"><div class=\"eqt-gallery-chip eqt-gallery-chip--gtl\"><span class=\"eqt-gallery-chip__body\">full color</span></div><div class=\"eqt-gallery-chip eqt-gallery-chip--gtw\"><span class=\"eqt-gallery-chip__body\">story arc</span></div></div></div>", 2)])], 4)])
							]),
							createBaseVNode("section", _hoisted_88, [createBaseVNode("h4", _hoisted_89, [createVNode(unref(MousePointerClick), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("settings.galleryDblClickActions")), 1)]), (openBlock(), createElementBlock(Fragment, null, renderList(galleryDblClickOptions, ({ labelKey, ref: r, newTabRef }) => {
								return createBaseVNode("div", {
									key: labelKey,
									class: "eqt-settings__field-row"
								}, [
									createBaseVNode("label", _hoisted_90, toDisplayString(unref(t)(labelKey)), 1),
									createBaseVNode("select", {
										class: "eqt-settings__select",
										value: r.value,
										disabled: !unref(taggingEnhancerEnabled),
										...
										return openBlock(), createElementBlock("option", {
											key: a.id,
											value: a.id
										}, toDisplayString(unref(t)(a.labelKey)), 9, _hoisted_92);
									}), 128))], 40, _hoisted_91),
									r.value === "searchNewTab" ? (openBlock(), createElementBlock("label", _hoisted_93, [createBaseVNode("input", {
										type: "checkbox",
										checked: newTabRef.value,
										disabled: !unref(taggingEnhancerEnabled),
										onChange: ($event) => newTabRef.value = $event.target.checked
									}, null, 40, _hoisted_94), createBaseVNode("span", _hoisted_95, toDisplayString(unref(t)("settings.newTabActivate")), 1)])) : createCommentVNode("", true)
								]);
							}), 64))]),
							createBaseVNode("section", _hoisted_96, [
								createBaseVNode("h4", _hoisted_97, [createVNode(unref(Info), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("settings.sectionIntroPanel")), 1)]),
								createBaseVNode("div", _hoisted_98, [createBaseVNode("label", _hoisted_99, toDisplayString(unref(t)("settings.introPanelPrimaryLang")), 1), createBaseVNode("div", _hoisted_100, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(INTRO_PANEL_PRIMARY_LANGS), (m) => {
									return openBlock(), createElementBlock("button", {
										key: m.id,
										type: "button",
									...
									}, toDisplayString(unref(t)(m.labelKey)), 11, _hoisted_101);
								}), 128))])]),
								createBaseVNode("p", _hoisted_102, toDisplayString(unref(t)("settings.introPanelPrimaryLangHint")), 1),
								createBaseVNode("label", _hoisted_103, [createBaseVNode("input", {
									type: "checkbox",
									checked: unref(wikiPreludeExpanded),
									disabled: !unref(taggingEnhancerEnabled),
									onChange: _cache[13] || (_cache[13] = ($event) => wikiPreludeExpanded.value = $event.target.checked)
								}, null, 40, _hoisted_104), createBaseVNode("span", _hoisted_105, toDisplayString(unref(t)("settings.wikiPreludeExpanded")), 1)]),
								createBaseVNode("p", _hoisted_106, toDisplayString(unref(t)("settings.wikiPreludeExpandedHint")), 1)
							])
						], 512), [[vShow, activeTab.value === "gallery"]]),
						withDirectives(createBaseVNode("div", _hoisted_107, [
							createBaseVNode("section", _hoisted_108, [
								createBaseVNode("h4", _hoisted_109, [createVNode(unref(Database), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("settings.tagDbSection")), 1)]),
								createBaseVNode("div", _hoisted_110, [
									withDirectives(createBaseVNode("select", {
										class: "eqt-settings__select",
										"onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => isRef(tagDbMirror) ? tagDbMirror.value = $event : null),
										title: unref(t)("settings.tagDbMirror")
									}, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(mirrorOptions), (opt) => {
										return openBlock(), createElementBlock("option", {
											key: opt.value,
											value: opt.value
										}, toDisplayString(opt.label), 9, _hoisted_112);
									}), 128))], 8, _hoisted_111), [[vModelSelect, unref(tagDbMirror)]]),
									withDirectives(createBaseVNode("input", {
										class: "eqt-settings__input eqt-settings__input--short",
										type: "number",
										min: "1",
										max: "30",
										"onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => isRef(tagDbTtlDays) ? tagDbTtlDays.value = $event : null),
									...
									}, [createVNode(unref(RotateCcw), { size: 12 }), createTextVNode(" " + toDisplayString(refreshing.value ? unref(t)("settings.tagDbRefreshing") : unref(t)("settings.tagDbRefresh")), 1)], 8, _hoisted_114)
								]),
								createBaseVNode("div", _hoisted_115, [createBaseVNode("input", {
									class: "eqt-settings__text-input eqt-settings__text-input--full",
									value: tagDbUrl.value,
									readonly: ""
								}, null, 8, _hoisted_116)])
							]),
							createBaseVNode("section", _hoisted_117, [
								createBaseVNode("h4", _hoisted_118, [createVNode(unref(ChartColumn), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("settings.tagCountSection")), 1)]),
								createBaseVNode("div", _hoisted_119, [
									withDirectives(createBaseVNode("select", {
										class: "eqt-settings__select",
										"onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => isRef(tagCountMirror) ? tagCountMirror.value = $event : null),
										...
										return openBlock(), createElementBlock("option", {
											key: opt.value,
											value: opt.value
										}, toDisplayString(opt.label), 9, _hoisted_121);
									}), 128))], 8, _hoisted_120), [[vModelSelect, unref(tagCountMirror)]]),
									withDirectives(createBaseVNode("input", {
										class: "eqt-settings__input eqt-settings__input--short",
										type: "number",
										min: "1",
										max: "30",
										"onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => isRef(tagCountTtlDays) ? tagCountTtlDays.value = $event : null),
									...
									}, [createVNode(unref(RotateCcw), { size: 12 }), createTextVNode(" " + toDisplayString(refreshingTagCount.value ? unref(t)("settings.tagCountRefreshing") : unref(t)("settings.tagCountRefresh")), 1)], 8, _hoisted_123)
								]),
								createBaseVNode("div", _hoisted_124, [createBaseVNode("input", {
									class: "eqt-settings__text-input eqt-settings__text-input--full",
									value: tagCountUrl.value,
									readonly: ""
								}, null, 8, _hoisted_125)])
							]),
							createBaseVNode("section", _hoisted_126, [
								createBaseVNode("h4", _hoisted_127, [createVNode(unref(BookOpen), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("settings.tagWikiSection")), 1)]),
								createBaseVNode("div", _hoisted_128, [
									withDirectives(createBaseVNode("select", {
										class: "eqt-settings__select",
										"onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => isRef(tagWikiMirror) ? tagWikiMirror.value = $event : null),
										...
										return openBlock(), createElementBlock("option", {
											key: opt.value,
											value: opt.value
										}, toDisplayString(opt.label), 9, _hoisted_130);
									}), 128))], 8, _hoisted_129), [[vModelSelect, unref(tagWikiMirror)]]),
									withDirectives(createBaseVNode("input", {
										class: "eqt-settings__input eqt-settings__input--short",
										type: "number",
										min: "1",
										max: "30",
										"onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => isRef(tagWikiTtlDays) ? tagWikiTtlDays.value = $event : null),
									...
									}, [createVNode(unref(RotateCcw), { size: 12 }), createTextVNode(" " + toDisplayString(refreshingTagWiki.value ? unref(t)("settings.tagWikiRefreshing") : unref(t)("settings.tagWikiRefresh")), 1)], 8, _hoisted_132)
								]),
								createBaseVNode("div", _hoisted_133, [createBaseVNode("input", {
									class: "eqt-settings__text-input eqt-settings__text-input--full",
									value: tagWikiUrl.value,
									readonly: ""
								}, null, 8, _hoisted_134)])
							])
						], 512), [[vShow, activeTab.value === "data"]]),
						withDirectives(createBaseVNode("div", _hoisted_135, [
							createBaseVNode("section", _hoisted_136, [
								createBaseVNode("h4", _hoisted_137, [createVNode(unref(Languages), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("settings.language")), 1)]),
								createBaseVNode("div", _hoisted_138, [(openBlock(), createElementBlock(Fragment, null, renderList(localeOptions, (opt) => {
									return createBaseVNode("button", {
										key: opt.value,
										type: "button",
									...
									}, toDisplayString(opt.label), 11, _hoisted_139);
								}), 64))]),
								createBaseVNode("p", _hoisted_140, toDisplayString(unref(t)("settings.languageHint")), 1)
							]),
							createBaseVNode("section", _hoisted_141, [
								createBaseVNode("h4", _hoisted_142, [createVNode(unref(Replace), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("settings.convertToTraditional")), 1)]),
								createBaseVNode("div", _hoisted_143, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(CONVERT_TO_TRADITIONAL_MODES), (m) => {
									return openBlock(), createElementBlock("button", {
										key: m.id,
										type: "button",
									...
									}, toDisplayString(unref(t)(m.labelKey)), 11, _hoisted_144);
								}), 128))]),
								createBaseVNode("p", _hoisted_145, toDisplayString(unref(t)("settings.convertToTraditionalHint")), 1)
							]),
							createBaseVNode("section", _hoisted_146, [
								createBaseVNode("h4", _hoisted_147, [createVNode(unref(Type), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("settings.fontFamily")), 1)]),
								createBaseVNode("div", _hoisted_148, [createBaseVNode("input", {
									value: unref(fontFamily),
									class: "eqt-settings__text-input eqt-settings__text-input--full",
									placeholder: unref(t)("settings.fontFamilyPlaceholder"),
									onInput: _cache[20] || (_cache[20] = ($event) => fontFamily.value = $event.target.value)
								}, null, 40, _hoisted_149)]),
								createBaseVNode("p", _hoisted_150, [createTextVNode(toDisplayString(unref(t)("settings.fontFamilyHint")), 1), _cache[25] || (_cache[25] = createBaseVNode("code", null, "\"Noto Sans TC\", sans-serif", -1))]),
								createBaseVNode("div", _hoisted_151, [
									createBaseVNode("label", _hoisted_152, toDisplayString(unref(t)("settings.fontWeight")), 1),
									createBaseVNode("input", {
										...
										onInput: _cache[21] || (_cache[21] = ($event) => fontWeight.value = $event.target.value)
									}, null, 40, _hoisted_153),
									createBaseVNode("span", _hoisted_154, toDisplayString(unref(fontWeight) || "400"), 1)
								])
							]),
							createBaseVNode("section", _hoisted_155, [createBaseVNode("h4", _hoisted_156, [createVNode(unref(Eye), { size: 14 }), createTextVNode(" " + toDisplayString(unref(t)("settings.preview")), 1)]), createBaseVNode("div", { class: normalizeClass(["eqt-settings__font-preview", unref(currentTagStyleClass)]) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(previewLines.value, (line, li) => {
								return openBlock(), createElementBlock(Fragment, { key: li }, [line.kind === "buttons" && line.buttons.some((b) => b.kind !== "spacer") ? (openBlock(), createElementBlock("div", {
									key: 0,
									class: "eqt-settings__preview-line",
									style: normalizeStyle({ justifyContent: unref(textAlignToJustify)(line.style?.textAlign ?? unref(buttonLineTextAlign)) })
						...
						], 512), [[vShow, activeTab.value === "general"]]),
					...
					createBaseVNode("aside", _hoisted_157, [
						createBaseVNode("h4", _hoisted_158, toDisplayString(unref(t)("settings.profilesTitle")), 1),
						...
						unref(deletedProfiles).length ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createBaseVNode("h4", _hoisted_159, toDisplayString(unref(t)("settings.trash")), 1), createBaseVNode("ul", _hoisted_160, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(deletedProfiles), (p, i) => {
						...
						unref(corruptedProfiles).length ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [createBaseVNode("h4", _hoisted_161, toDisplayString(unref(t)("settings.corrupted")), 1), createBaseVNode("ul", _hoisted_162, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(corruptedProfiles), (c, i) => {
							return openBlock(), createBlock(ProfileListItem_default, {
								key: i,
	...
	var SearchPopup_default = defineComponent({
		...
		setup(__props, { emit: __emit }) {
			...
			async function execBgDblClick(action, newTabActive) {
	...
	function resolveCohort(cohort, startState, chipState, mode) {
		if (cohort !== null && startState !== null) return {
			cohort,
			startState
		};
		return {
			cohort: computeCohort(chipState, mode),
			startState: chipState
		};
	}
	function decideChip(chip, ctx) {
	...
	function reducePressed(state, event, config) {
		...
		for (const chip of [state.initialChip, event.chip]) {
			...
			const { apply, follow } = decideChip(chip, {
				cohort,
				startState,
				toggled
			});
	...
	function reduceDragging(state, event) {
		...
		const { apply, follow } = decideChip(event.chip, {
			cohort,
			startState,
			toggled: state.toggled
		});
		if (!apply && !follow) return {
			state: {
				...state,
				cohort,
				startState
		...
		if (event.chip.id !== state.panelId) effects.push({
			kind: "panelTag",
			id: event.chip.id
		});
		return {
	...
	var GalleryTagList_default = defineComponent({
		...
		setup(__props, { emit: __emit }) {
			...
			function execGalleryDblClickAction(action, newTabActive) {
				switch (action) {
					case "none": return;
					case "search":
						onSearchCurrent();
			...
			function doSearchNewTab(activate) {
				const href = buildSearchUrl();
				if (!href) return;
				Promise.resolve(_GM.openInTab(href, { active: activate })).catch(() => {});
				onClearSelection();
			}
	...
	var GalleryIntroPanel_default = defineComponent({
		...
		setup(__props) {
			const { openTag, entry, introHtml, linksHtml, iconUrl, wikiEntry, wikiUrl, extraImages, displayedLang, toggleLang, close, zhDisplay, preludeExpanded, togglePrelude } = useIntroPanel();
				...
				return openBlock(), createBlock(Teleport, {
					...
					createBaseVNode("div", _hoisted_2, [
						createBaseVNode("div", _hoisted_3, [unref(displayedLang) === "en" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createBaseVNode("a", {
							...
							alt: "",
							referrerpolicy: "no-referrer"
						}, null, 8, _hoisted_8)) : createCommentVNode("", true), createTextVNode(toDisplayString(unref(zhDisplay)(unref(entry).name)), 1)])) : createCommentVNode("", true), createBaseVNode("code", _hoisted_9, toDisplayString(unref(openTag).nsRaw), 1)], 64))]),
						createBaseVNode("button", {
							type: "button",
					...
					createBaseVNode("div", {
						ref_key: "contentEl",
						ref: contentEl,
						class: normalizeClass(["eqt-intro-panel__content", { "is-scrollable": contentScrollable.value }])
					...
					}), 128))])) : createCommentVNode("", true)], 64))], 2),
	...
	var App_default = defineComponent({
		...
		setup(__props) {
			...
			function applyGalleryLayout() {
				...
				anchor.closest("#gmid")?.style.setProperty("--eqt-gallery-height", `${galleryTaglistHeight.value}px`);
			}
			...
			function onSearch(action, newTabActive) {
				if (searchInput?.form) {
					if (action === "searchNewTab") {
						...
						Promise.resolve(_GM.openInTab(url.href, { active: newTabActive ?? true })).catch(() => {});
			...
			return (_ctx, _cache) => {
				return openBlock(), createElementBlock(Fragment, null, [
					...
					urlPopupValue.value ? (openBlock(), createBlock(UrlConfigPopup_default, {
						...
						onSave,
						onClose
					}, null, 8, ["tag", "line-color"])) : createCommentVNode("", true),
