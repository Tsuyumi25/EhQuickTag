export default {
  ...
  'tagbar.separatorEnable': '区切り線を有効化',
  'tagbar.separatorEmptyOnly': '空行のみ区切り線を有効化できます',
  ...
  'tagbar.separatorPreset': 'プリセット',
  'tagbar.separatorPreset_divider': 'テキスト区切り',
  'tagbar.separatorPreset_header': '見出し',
