export default {
  ...
  'settings.galleryTaglistHeightMode': 'タグ一覧の高さ',
  'settings.galleryTaglistHeight': '固定高さ',
  'settings.galleryTaglistExpand': '自動展開',
  'settings.galleryTaglistExpandHint': '固定高さ＝設定した高さを保ち、タグが多いと枠内スクロール（単位 px、既定 330＝元の高さ）。自動展開＝下方向に伸びてスクロールせず、元の最低高さを維持。',
