export default {
  ...
  'bars.accuracy': '判定済み {judged} 件中 {correct} 件が一致（誤検知 {over} · 漏れ {leak}）',
  ...
  'panel.effectOne': '「{tag}」を変更',
  'panel.effectMany': 'タグ {n} 件を変更',
  ...
  'panel.newSetPrompt': '新しいタグセットの名前',
  'panel.newSetDefault': '新しいタグセット',
  'panel.setDialogTitle': 'タグセット設定',
  'panel.setName': '名称',
  'panel.setColor': '既定色',
  'panel.setEnabled': 'このセットのフラグと注目を有効にする',
  'panel.setColorNote': '独自の色を持たないタグはこの色を継承します。破線のボタンはページを再読み込みします。',
  'panel.rename': '名前を変更',
  'panel.saveSet': '保存',
  'panel.deleteSet': 'タグセットを削除',
  'taglist.allSets': 'すべて',
  'taglist.newSet': 'セットを追加',
  'taglist.setSettings': 'セット設定',
  ...
  'preview.title': 'ギャラリー結果',
  'preview.filterLeft': '弾かれる',
  'preview.filterRight': '表示される',
  'preview.summaryAll': 'サンプル {n} 件',
  'preview.summaryTag': '「{tag}」を含むサンプル {n} 件',
  'preview.markedOnly': '判定済みのみ',
  'preview.refresh': 'サンプル更新',
  'preview.loadMore': 'さらに見る',
  'preview.sideEmpty': 'この側にはまだ何もありません',
  'preview.moved': 'ギャラリー {n} 件が反対側へ',
  'preview.diagnostic': '判定済み：修正 {fixed} 件、新たな不一致 {introduced} 件',
  'preview.sum': '合計 {n}',
