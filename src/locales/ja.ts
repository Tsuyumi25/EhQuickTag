export default {
  ...
  'panel.labelHidden': '非表示',
  'panel.labelWatch': 'ウォッチ',
  'panel.labelDelete': '削除',
  'panel.applying': '送信中 {i}/{n}⋯',
  'panel.applied': '{n} 件を適用しました',
  'panel.applyingThreshold': 'フィルタ閾値を書き込み中…',
  'panel.thresholdApplied': 'フィルタ閾値を {n} にしました',
  ...
  'panel.expandEditor': '編集欄を既定の幅で展開',
  'marked.over': '誤検知',
  'marked.leak': '漏れ',
  'marked.hiddenBy': '完全非表示で弾かれています：{tags}',
  ...
  'manage.newTag': '新しいタグ',
  'manage.pickCandidate': '下の一覧からタグを選ぶと下書きを開始します。',
  'manage.weight': '重み',
  'manage.color': '色',
  'manage.targetSet': '追加先',
  'manage.moveTarget': '移動先',
  'manage.moveTag': 'タグを移動',
  'manage.setFull': 'このタグセットは上限に達しています。',
  'manage.colorInvalid': '6桁の16進カラーコードを入力してください。',
  'manage.searchPlaceholder': 'タグを検索',
  'taglist.filterWatch': 'ウォッチ',
  'taglist.filterHidden': '非表示',
  'taglist.sortLabel': 'タグの並び順',
  'taglist.sortNegative': '負の重み順',
  'taglist.sortPositive': '正の重み順',
  'taglist.sortColor': '色順',
  'taglist.statusAll': 'すべての状態',
  'taglist.statusWeighted': '既定以外の重み',
  'taglist.statusPending': '未適用',
  'taglist.headLeft': 'タグと影響（{n}）',
  ...
  'taglist.bulkWatch': 'ウォッチにする',
  'taglist.bulkHide': '非表示にする',
  'taglist.clearPicks': '選択を解除',
  'preview.title': 'フィルタープレビュー',
  'preview.filterLeft': '弾かれる',
  'preview.filterRight': '表示される',
  'preview.layout': '並べ方',
  'preview.layoutMasonry': 'タイル',
  'preview.layoutGrid': '高さ揃え',
