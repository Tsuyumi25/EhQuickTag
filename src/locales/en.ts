export default {
  ...
  'panel.labelHidden': 'Hidden',
  'panel.labelWatch': 'Watched',
  'panel.labelDelete': 'Delete',
  'panel.applying': 'Sending {i}/{n}…',
  'panel.applied': 'Applied {n}',
  'panel.applyingThreshold': 'Writing filter threshold…',
  'panel.thresholdApplied': 'Filter threshold is now {n}',
  ...
  'panel.expandEditor': 'Expand editor to default width',
  'marked.over': 'over',
  'marked.leak': 'leak',
  'marked.hiddenBy': 'Hidden outright by: {tags}',
  ...
  'manage.pickCandidate': 'Pick a tag from the list below to start a draft.',
  'manage.weight': 'Weight',
  'manage.color': 'Colour',
  'manage.targetSet': 'Add to',
  'manage.moveTarget': 'Move to',
  'manage.moveTag': 'Move tag',
  'manage.setFull': 'This tag set is full.',
  'manage.colorInvalid': 'Enter a six-digit hex colour.',
  'manage.searchPlaceholder': 'Search tags',
  'taglist.filterWatch': 'Watched',
  'taglist.filterHidden': 'Hidden',
  'taglist.sortLabel': 'Tag order',
  'taglist.sortNegative': 'By negative weight',
  'taglist.sortPositive': 'By positive weight',
  'taglist.sortColor': 'By color',
  'taglist.statusAll': 'All states',
  'taglist.statusWeighted': 'Non-default weight',
  'taglist.statusPending': 'Not applied',
  'taglist.headLeft': 'Tag and impact ({n})',
  ...
  'taglist.bulkHide': 'Set hidden',
  'taglist.clearPicks': 'Clear selection',
  'preview.title': 'Filter preview',
  'preview.filterLeft': 'blocked',
  'preview.filterRight': 'shown',
  'preview.layout': 'Layout',
  'preview.layoutMasonry': 'Masonry',
  'preview.layoutGrid': 'Uniform grid',
