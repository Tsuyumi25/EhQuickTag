export default {
  ...
  'bars.accuracy': '{correct} of {judged} judged match ({over} over-blocked · {leak} leaked)',
  ...
  'panel.effectOne': 'Changed “{tag}”',
  'panel.effectMany': 'Changed {n} tags',
  ...
  'panel.newSetPrompt': 'Name for the new tag set',
  'panel.newSetDefault': 'New Tagset',
  'panel.setDialogTitle': 'Tag set settings',
  'panel.setName': 'Name',
  'panel.setColor': 'Default colour',
  'panel.setEnabled': 'Enable flagging and watching for this set',
  'panel.setColorNote': 'Tags without their own colour inherit this one. Dashed buttons reload the page.',
  'panel.rename': 'Rename',
  'panel.saveSet': 'Save',
  'panel.deleteSet': 'Delete tag set',
  'taglist.allSets': 'All',
  'taglist.newSet': 'New set',
  'taglist.setSettings': 'Set settings',
  ...
  'preview.title': 'Gallery results',
  'preview.filterLeft': 'blocked',
  'preview.filterRight': 'shown',
  'preview.summaryAll': '{n} samples',
  'preview.summaryTag': '{n} samples carrying “{tag}”',
  'preview.markedOnly': 'Marked only',
  'preview.refresh': 'Refresh samples',
  'preview.loadMore': 'Keep going',
  'preview.sideEmpty': 'Nothing on this side yet',
  'preview.moved': '{n} galleries changed side',
  'preview.diagnostic': 'Marked cases: {fixed} fixed, {introduced} newly inconsistent',
  'preview.sum': 'Total {n}',
