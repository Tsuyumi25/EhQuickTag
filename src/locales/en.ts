export default {
  ...
  'settings.useNhWeightHint': 'When enabled, search suggestions and the "+ Find tag" default list are sorted by each tag\'s gallery count on nhentai—tags with more galleries come first, others follow the default formula.\nNote: nhentai\'s general tag pool isn\'t split by namespace, so female / male / mixed / other share the same ranking and may not reflect actual e-hentai counts.',
