export default {
  ...
  'settings.galleryTaglistHeight': 'Fixed height',
  'settings.galleryTaglistExpand': 'Auto-expand',
  'settings.galleryTaglistExpandHint': 'Fixed height: keeps the set height and scrolls when tags overflow (in px; default 330 = native). Auto-expand: the area grows downward with no scrollbar, keeping at least the native height.',
