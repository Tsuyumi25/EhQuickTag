export default {
  ...
  'settings.galleryTaglistHeightMode': '標籤列高度',
  'settings.galleryTaglistHeight': '固定高度',
  'settings.galleryTaglistExpand': '自動展開',
  'settings.galleryTaglistExpandHint': '固定高度＝維持設定的高度、標籤過多時框內捲動（單位 px，預設 330＝原生高度）；自動展開＝整區隨標籤往下長、不留捲軸，並維持原生最低高度。',
