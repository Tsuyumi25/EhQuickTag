export default {
  ...
  'panel.labelHidden': '隱藏',
  'panel.labelWatch': '關注',
  'panel.labelDelete': '刪除',
  'panel.applying': '送出中 {i}/{n}⋯',
  'panel.applied': '已套用 {n} 個',
  'panel.applyingThreshold': '寫入過濾門檻⋯',
  'panel.thresholdApplied': '過濾門檻已改成 {n}',
  ...
  'panel.expandEditor': '以預設寬度展開編輯區',
  'marked.over': '誤傷',
  'marked.leak': '漏網',
  'marked.hiddenBy': '被硬隱藏擋住：{tags}',
  ...
  'taglist.addTag': '新增標籤',
  'manage.newTag': '新增標籤',
  'manage.pickCandidate': '從下方清單選擇標籤以建立草稿。',
  'manage.weight': '權重',
  'manage.color': '顏色',
  'manage.targetSet': '加入到',
  'manage.moveTarget': '移動到',
  'manage.moveTag': '移動標籤',
  'manage.setFull': '這個標籤集已滿。',
  'manage.colorInvalid': '請輸入六位十六進位色號。',
  'manage.searchPlaceholder': '搜尋標籤',
  'taglist.filterWatch': '關注',
  'taglist.filterHidden': '隱藏',
  'taglist.sortLabel': '標籤排序',
  'taglist.sortNegative': '按負權重',
  'taglist.sortPositive': '按正權重',
  'taglist.sortColor': '按顏色排序',
  'taglist.statusAll': '全部狀態',
  'taglist.statusWeighted': '非預設權重',
  'taglist.statusPending': '未套用',
  'taglist.headLeft': '標籤與影響（{n}）',
  ...
  'taglist.bulkHide': '設為隱藏',
  'taglist.clearPicks': '取消選取',
  'preview.title': '過濾預覽',
  'preview.filterLeft': '被擋',
  'preview.filterRight': '會顯示',
  'preview.layout': '排列',
  'preview.layoutMasonry': '瀑布流',
  'preview.layoutGrid': '等高網格',
  ...
  'preview.sum': '合計 {n}',
  'preview.threshold': '門檻 {n}',
  'preview.shouldBlock': '該擋',
  'preview.shouldKeep': '該留',
  'panel.applyN': '套用 {n} 個到 EH',
  'gallery.open': '打開圖庫',
  'gallery.loading': '載入中⋯',
  'gallery.failed': '這本抓不回來。',
