export default {
  ...
  'bars.accuracy': '已判 {judged} 本，這組設定對 {correct} 本（誤傷 {over} · 漏網 {leak}）',
  ...
  'panel.effectOne': '改了「{tag}」',
  'panel.effectMany': '改了 {n} 個標籤',
  'panel.pickTagFirst': '先在左邊選一個標籤。',
  'panel.working': '處理中⋯',
  'panel.massFailed': '這批沒送成功，清單可能不是最新的。',
  'panel.deleteConfirmMany': '確定要從 EH 刪掉 {n} 個標籤嗎？沒有還原。',
  'panel.newSetPrompt': '新標籤集的名字',
  'panel.newSetDefault': '新標籤集',
  'panel.setDialogTitle': '標籤集設定',
  'panel.setName': '名稱',
  'panel.setColor': '預設顏色',
  'panel.setEnabled': '啟用這個標籤集的標記與關注',
  'panel.setColorNote': '沒有自訂顏色的標籤會沿用這裡的顏色。虛線按鈕會重整頁面。',
  'panel.rename': '重新命名',
  'panel.saveSet': '儲存',
  'panel.deleteSet': '刪除標籤集',
  'taglist.allSets': '全部',
  'taglist.newSet': '新增標籤集',
  'taglist.setSettings': '標籤集設定',
  ...
  'preview.summaryAll': '共 {n} 本樣本',
  'preview.summaryTag': '只看帶有「{tag}」的 {n} 本樣本',
  'preview.markedOnly': '只看已標記',
  'preview.refresh': '更新樣本',
  'preview.loadMore': '繼續往下看',
  'preview.sideEmpty': '這一邊還沒有東西',
  'preview.moved': '{n} 本畫廊換邊',
  'preview.diagnostic': '已標記案例：修正 {fixed}，新增不一致 {introduced}',
  'preview.sum': '合計 {n}',
