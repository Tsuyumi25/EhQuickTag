export default {
  ...
  'settings.useNhWeight': '按 nhentai 作品数量排序',
  'settings.useNhWeightHint': '开启后，搜索建议跟「+ 寻找标签」预设清单会按 nhentai 各 tag 的作品数量排序，数量多的排前面，其余按默认公式排序。\n注意：nhentai 的一般 tag 池不分 namespace，所以 female / male / mixed / other 四个 ns 共用同一份排序，不一定反映 e-hentai 端的实际数量。',
