export default {
  ...
  'tagbar.separatorEnable': '启用分隔线',
  'tagbar.separatorEmptyOnly': '只有空行可启用分隔线',
  ...
  'tagbar.separatorPreset': '版型',
  'tagbar.separatorPreset_divider': '文字分隔',
  'tagbar.separatorPreset_header': '段落标题',
