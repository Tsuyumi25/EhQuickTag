export default {
  ...
  'preview.layoutGrid': '等高网格',
  'preview.columnCount': '{side}（{shown}/{total}）',
  'preview.markedOnly': '只看已标记',
