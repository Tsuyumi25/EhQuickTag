export default {
  ...
  'settings.tagAppearance': '标签外观',
  'settings.appearanceExample': '示例 {n}',
  'settings.appearanceColors': '显示个人颜色',
  'settings.appearanceScores': '显示分数',
  'settings.appearanceMarks': '显示关注与隐藏标记',
  ...
  'panel.labelHidden': '隐藏',
  'panel.labelWatch': '关注',
  'panel.labelDelete': '删除',
  'panel.applying': '送出中 {i}/{n}⋯',
  'panel.applied': '已套用 {n} 个',
  'panel.applyingThreshold': '写入过滤阈值⋯',
  'panel.thresholdApplied': '过滤阈值已改成 {n}',
  ...
  'preview.expungedOnly': '已删除',
  'preview.fetchExpunged': '抓取已删除的样本',
  ...
  'panel.expandEditor': '以默认宽度展开编辑区',
  'marked.over': '误伤',
  'marked.leak': '漏网',
  'marked.hiddenBy': '被硬隐藏挡住：{tags}',
  ...
  'taglist.addTag': '新增标签',
  'manage.newTag': '新增标签',
  'manage.pickCandidate': '从下方列表选择标签以建立草稿。',
  'manage.weight': '权重',
  'manage.color': '颜色',
  'manage.targetSet': '加入到',
  'manage.moveTarget': '移动到',
  'manage.moveTag': '移动标签',
  'manage.setFull': '这个标签集已满。',
  'manage.colorInvalid': '请输入六位十六进制色号。',
  'manage.searchPlaceholder': '搜索标签',
  'taglist.filterWatch': '关注',
  'taglist.filterHidden': '隐藏',
  'taglist.sortLabel': '标签排序',
  'taglist.sortNegative': '按负权重',
  'taglist.sortPositive': '按正权重',
  'taglist.sortColor': '按颜色排序',
  'taglist.statusAll': '全部状态',
  'taglist.statusWeighted': '非默认权重',
  'taglist.statusPending': '未套用',
  'taglist.headLeft': '标签与影响（{n}）',
  ...
  'taglist.bulkHide': '设为隐藏',
  'taglist.clearPicks': '取消选取',
  'preview.title': '过滤预览',
  'preview.filterLeft': '被挡',
  'preview.filterRight': '会显示',
  'preview.columnCount': '{side}（{shown}/{total}）',
  'preview.markedOnly': '已标记',
  'preview.coverSize': '封面大小',
  'preview.refresh': '抓取样本',
  'preview.loadMore': '继续往下看',
  'preview.sideEmpty': '这一边还没有东西',
  'preview.sum': '合计 {n}',
  'preview.threshold': '门槛 {n}',
