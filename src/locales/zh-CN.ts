export default {
  ...
  'bars.accuracy': '已判 {judged} 本，这组设置对 {correct} 本（误伤 {over} · 漏网 {leak}）',
  ...
  'panel.effectMany': '改了 {n} 个标签',
  'panel.pickTagFirst': '先在左边选一个标签。',
  'panel.working': '处理中⋯',
  'panel.massFailed': '这批没送成功，列表可能不是最新的。',
  'panel.deleteConfirmMany': '确定要从 EH 删掉 {n} 个标签吗？没有还原。',
  'panel.newSetPrompt': '新标签集的名字',
  'panel.newSetDefault': '新标签集',
  'panel.setDialogTitle': '标签集设置',
  'panel.setName': '名称',
  'panel.setColor': '默认颜色',
  'panel.setEnabled': '启用这个标签集的标记与关注',
  'panel.setColorNote': '没有自定颜色的标签会沿用这里的颜色。虚线按钮会重整页面。',
  'panel.rename': '重命名',
  'panel.saveSet': '保存',
  'panel.deleteSet': '删除标签集',
  'taglist.allSets': '全部',
  'taglist.newSet': '新增标签集',
  'taglist.setSettings': '标签集设置',
  ...
  'preview.summaryAll': '共 {n} 本样本',
  'preview.summaryTag': '只看带有「{tag}」的 {n} 本样本',
  'preview.markedOnly': '只看已标记',
  'preview.refresh': '更新样本',
  'preview.loadMore': '继续往下看',
  'preview.sideEmpty': '这一边还没有东西',
  'preview.moved': '{n} 本画廊换边',
  'preview.diagnostic': '已标记案例：修正 {fixed}，新增不一致 {introduced}',
  'preview.sum': '合计 {n}',
